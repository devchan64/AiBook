...
- `AGENTS.md`는 저장소 전역에 적용되는 기준과, 작업 중 놓치기 쉬운 `먼저 확인할 문서`만 남깁니다.
...
- 다국어를 본격 도입할 때는 기본적으로 다음 원칙을 따릅니다.
  - 한국어 기준 본문은 `section-01.md`처럼 기본 파일로 두고, 번역본은 가능하면 같은 폴더의 `section-01.en.md`, `section-01.zh.md`처럼 언어 접미사 파일로 함께 둡니다.
