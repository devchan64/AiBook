...
개인 PC에 파이썬을 설치하고 가상환경을 관리하는 방법은 `P2-7.1`, `P2-7.6`, `P2-7.7`, `P2-7.8`에서 다시 다룹니다. 여기서는 Colab과 로컬 PC의 실행 위치 차이를 먼저 잡습니다. 용어를 다시 빠르게 확인할 때는 [개념사전의 노트북 항목](../../../reference/concept-glossary-parts/02-nieun.md#notebook)도 함께 봅니다.
