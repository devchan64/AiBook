...
- 고등학교 미분 기억과 AI 학습 문서 사이 간격이 커서 그래디언트, 경사하강법, 역전파가 한꺼번에 낯설게 느껴질 때 먼저 떠올립니다.
- 편미분, 방향도함수, 그래디언트가 각각 무엇을 다르게 보는지 천천히 다시 정리해야 할 때 먼저 떠올립니다.
- 본문 절만으로는 다변수 미분 감각이 부족해 보충 설명이 더 필요한 독자를 상정할 때 먼저 떠올립니다.
