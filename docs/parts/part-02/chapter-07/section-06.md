...
이 보충학습은 “명령을 어디에 입력하고, 현재 위치를 어떻게 확인하며, 실습 폴더로 어떻게 이동하는가”를 연습합니다. Python 설치는 P2-7.7에서 따로 보고, 여기서는 운영체제별 터미널에서 같은 목적의 점검을 어떻게 수행하는지에 집중합니다.
...
## 운영체제별 터미널 진입: 확인할 판단 기준

이 사례 절은 다음 질문으로 중심축을 확인한다.

- 오픈체크리스트의 중심축 문장인 "운영체제별 터미널 사용법을 초심자 기준으로 보충해야 합니다."를 본문 사례에서 어느 대목으로 확인할 수 있는가?
