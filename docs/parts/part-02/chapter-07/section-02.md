...
## 핵심 기준: 터미널(terminal), 셸(shell), 작업 폴더(working directory)
...
## 터미널, 셸, 작업 폴더: 확인할 판단 기준

이 사례 절은 다음 질문으로 중심축을 확인한다.

- 오픈체크리스트의 중심축 문장인 "터미널, 셸, 작업 폴더가 왜 기본 실행 단위인지 보여 주어야 합니다."를 본문 사례에서 어느 대목으로 확인할 수 있는가?
