...
여기에는 중요한 생략이 있습니다. 실제로는 가상환경을 활성화(activate)하는 단계가 필요할 수 있습니다. 운영체제별 활성화 명령은 Windows, macOS, Linux에서 다르게 보이므로 이 절에서는 외우지 않습니다. 자세한 사용 절차는 P2-7.7 보충수업에서 다룹니다.
