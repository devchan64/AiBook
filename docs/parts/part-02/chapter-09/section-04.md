...
Part 2 Chapter 9에서는 `전통적인 자료구조 이름을 처음 읽는 기준`을 이 보충학습에 둡니다. 본편이 구조 선택 질문을 먼저 다뤘다면, 이 절은 배열·연결 리스트·스택·큐·트리·그래프·해시 테이블 같은 이름을 질문 중심으로 다시 읽게 하는 보충 기준점입니다.
...
이 보충학습은 아래 기준을 회수한 뒤 본편으로 돌아갑니다.
