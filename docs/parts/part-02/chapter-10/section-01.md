...
- 코드와 설명, 출력과 해석을 한 자리에서 함께 남기며 배우고 싶을 때 노트북 관점을 먼저 떠올립니다.
- 스크립트 하나만으로는 학습 흔적과 실험 맥락을 남기기 어려울 때 이 절의 기록 형식을 다시 봅니다.
- 셀 실행 순서와 결과 해석이 함께 중요해지는 수학·Python·AI 실습을 정리할 때 다시 확인합니다.
