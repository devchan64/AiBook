...
## 핵심 기준: 확률(probability)은 불확실성을 어떻게 숫자로 표현하는가
...
베이즈 규칙은 P2-5.1의 핵심 계산 대상은 아닙니다. 여기서는 “확률은 새로운 관측으로 갱신될 수 있다”는 관점만 남기고, 계산 절차 전체보다 `무엇이 판단을 바꾸는가`라는 질문을 먼저 붙잡습니다.
...
## 확률은 불확실성을 어떻게 숫자로 표현하는가: 확인할 판단 기준

이 사례 절은 다음 질문으로 중심축을 확인한다.

- 오픈체크리스트의 중심축 문장인 "확률을 불확실성을 수치로 다루는 언어로 다시 설명해야 합니다."를 본문 사례에서 어느 대목으로 확인할 수 있는가?
