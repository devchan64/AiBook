...
실행 환경은 P2-3.4의 [실행 환경을 먼저 구분한다](../chapter-03/section-04.md#_2)를 기준으로 확인합니다. 여기서는 파이썬 설치 방법을 다시 설명하지 않고, 통계 개념을 작은 코드로 확인하는 데 집중합니다.
...
여기서는 `ddof`를 외우기보다 다음 질문을 기억합니다.
