...
![모집단, 표본, 데이터셋의 포함 관계를 보여 주는 도식](../../../assets/part-02/chapter-05/population-sample-dataset-relation.svg)
...
![훈련 데이터와 테스트 데이터를 현실의 표본으로 보는 도식](../../../assets/part-02/chapter-05/train-test-as-samples.svg)
