...
| 아직 완벽히 외워야 하나? | 아닙니다. 다시 읽을 기준점과 낯설지 않은 용어 감각이 먼저 필요합니다. |
...
이 표의 목적은 Git 명령을 더 외우게 하는 데 있지 않습니다. 현재 절에서는 `계산을 했다`와 `무엇을 바꿔 어떤 결과가 달라졌는지 다시 설명할 수 있다`가 같은 말이 아니라는 점을 분명히 잡습니다. 그래서 Part 2의 Git은 개발자 부록이 아니라, Part 3 실험 비교를 다시 읽게 만드는 기록 손잡이로 이해하는 편이 더 안전합니다.
