...
| 질문 | 먼저 잡을 관점 |
| --- | --- |
| Part 2에서 무엇을 얻어야 하나? | 수학, Python, 데이터, 실습 환경의 최소 공통 언어를 얻어야 합니다. |
| 아직 완벽히 외워야 하나? | 아닙니다. 다시 읽을 기준점과 낯설지 않은 용어 감각이면 충분합니다. |
| Part 3로 넘어갈 준비는 무엇인가? | 데이터, 손실, 학습, 평가 같은 말을 무서워하지 않고 읽을 수 있으면 됩니다. |
