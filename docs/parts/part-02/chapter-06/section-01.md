...
처음 읽을 때는 정의 전체를 외우기보다 `후보가 있고`, `좋고 나쁨의 기준이 있고`, `더 나은 쪽으로 움직인다`는 세 문장만 먼저 붙잡으면 충분합니다.
...
학습은 다음처럼 보일 수 있습니다. 처음에는 잘 모르고, 일단 예측해 보고, 틀린 정도를 본 뒤, 조금 고치고, 다시 예측해 보는 흐름입니다.
