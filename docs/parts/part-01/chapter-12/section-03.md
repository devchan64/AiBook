...
여기서는 프롬프트의 한계와 검토 기준을 다룹니다. RAG(retrieval-augmented generation), 벡터 검색(vector search), 도구 사용(tool use), AI 에이전트(AI agent), 하네스(harness)는 자세히 다루지 않습니다. 그런 구조는 바로 다음 장의 P1-13.3과 P1-13.4, 그리고 P1-14.2부터 P1-14.5에서 다시 다룹니다.
...
- RAG, 도구 사용(tool use), AI 에이전트(AI agent), 하네스(harness)가 왜 다음 단계의 주제가 되는지 예고합니다.
...
- RAG, 도구 사용(tool use), AI 에이전트(AI agent), 하네스(harness)가 왜 다음 단계의 주제가 되는지 설명할 수 있다.
