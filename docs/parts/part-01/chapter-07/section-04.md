...
> 길찾기 문제는 자율주행 같은 실제 시스템에서  
> 어떻게 여러 층위의 계획(planning)으로 나뉘어 왔는가?
...
이 절은 자율주행 기술 전체를 배우는 절이 아니라, 탐색 개념이 실제 시스템에서 어떻게 나뉘는지 보는 보충학습입니다. 처음에는 아래 세 가지만 먼저 붙잡으면 됩니다.
...
| Chapter 7의 일반 개념 | 자율주행 사례에서의 대응 |
| --- | --- |
