...
![각 단계 선택지가 3개일 때 단계 수가 늘어나며 가능한 조합 수가 빠르게 커지는 그래프](/AiBook/assets/part-01/chapter-07/search-space-growth-ko.png)
...
- 현재 문제의 `상태`, `행동`, `목표`, `비용`을 직접 잡아 탐색 문제로 설명할 수 있다.
