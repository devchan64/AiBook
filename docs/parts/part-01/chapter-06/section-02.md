...
6.2는 확률 수식을 깊게 다루지 않습니다. 조건부 확률, 베이즈 규칙, 확률 분포 계산은 Part 2의 통계 기초 장과 Part 3의 평가·예측 장에서 다시 다룹니다.

또한 이 절은 LLM의 생성 원리를 설명하는 절도 아닙니다. LLM의 샘플링, temperature, top-p, 다음 토큰 예측은 Part 5의 P5-5.1 다음 토큰 예측, P5-5.2 생성 과정의 직관에서 다시 다룹니다.
