...
이 절은 규칙을 버리자는 절이 아니라, 규칙만으로 닫히지 않는 문제를 설명하는 절입니다. 처음에는 아래 세 가지만 먼저 붙잡으면 됩니다.
...
| 그래서 불확실성, 확률, 휴리스틱, 학습이 이어서 등장한다는 점 | Chapter 6과 7의 흐름을 한 번에 잡게 해 줍니다. | 규칙 다음에 왜 확률적 사고가 필요한지 감만 잡히면 충분합니다. |
