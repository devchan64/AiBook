...
P1-15.1에서는 AI 결과가 사람과 사회에 영향을 줄 때 편향(bias), 안전성(safety), AI 책임성(accountability)을 어떻게 봐야 하는지 살펴봤습니다. 이제 질문은 조금 더 구체적입니다.
...
- `표현 보호`, `인용 판단`, `학습 데이터 논쟁`, `자료 사용 보류 기준`을 나누어 저작권 검토를 설명할 수 있다.
