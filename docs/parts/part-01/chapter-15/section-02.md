...
이 절은 법률 결론을 단정하는 절이 아니라, 무엇을 조심해야 하는지 구분하는 절입니다. 처음에는 아래 세 가지만 먼저 붙잡으면 됩니다.
...
| 이 저장소에서는 보수적으로 자료 사용을 제한해야 한다는 점 | 실제 집필 원칙과 바로 연결됩니다. | 유료 출판물, 폐쇄형 강의자료, 무단 복제 PDF는 입력으로 쓰지 않는다고 이해하면 충분합니다. |
