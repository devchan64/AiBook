...
P1-14에서 에이전트(agent)는 목표를 여러 단계 작업으로 이어 가는 구조라고 설명했습니다. 이 구조는 유용하지만, 보안 관점에서는 권한이 커지는 순간 위험도 커집니다.
...
P1-15는 여기서 끝납니다. P1-16에서는 이 책과 실제 업무에서 AI를 어떻게 적용하고 검증할지 살펴봅니다.
