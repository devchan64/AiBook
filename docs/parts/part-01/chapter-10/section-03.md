...
이 절은 생성형 AI를 금지하거나 두려워하자는 절이 아니라, 결과를 어떻게 읽어야 하는지 정리하는 절입니다. 처음에는 아래 세 가지만 먼저 붙잡으면 됩니다.
...
| 위험은 품질만이 아니라 안전, 권리, 책임까지 포함한다는 점 | 뒤의 윤리·저작권·보안 장으로 자연스럽게 이어집니다. | “잘 써졌다”만으로는 충분하지 않다고 알면 충분합니다. |
