...
- Explain why personal intuition should be preserved as a `working hypothesis`.
...
> 1. leave behind personal memory and questions  
> 2. let AI produce candidate structure and explanation  
> 3. check outside evidence  
> 4. generalize the phrasing  
> 5. organize the result by section and share it  
> 6. revise when errors are found
