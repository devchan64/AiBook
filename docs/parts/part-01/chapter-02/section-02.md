...
이 절에서는 탐색 알고리즘을 깊게 다루지 않습니다. 너비 우선 탐색, 깊이 우선 탐색, A* 탐색, 게임 탐색, 휴리스틱 함수는 P1-7에서 다시 다룹니다. 여기서는 탐색을 “가능한 후보가 너무 많을 때 목표에 도달하는 경로를 찾는 방식”으로 기억하면 됩니다.
...
이 절에서는 베이즈 규칙이나 베이지안 네트워크를 계산하지 않습니다. 확률, 불확실성, stochastic의 차이는 P1-6에서 다시 다룹니다. 여기서는 확률 추론을 “불완전한 정보에서 가능한 결론의 그럴듯함을 계산하는 방식”으로 기억하면 됩니다.
