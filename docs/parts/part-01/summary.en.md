...
This summary is not a document that repeats every concept from Part 1 at length. It is a closing page that helps you recall where the baseline for each idea was first fixed. If the terms become confusing again, return to the [Concept Glossary](../../reference/concept-glossary.md) and the representative Sections listed there.
