...
같은 Part 안에서 중요한 개념의 상세 설명은 가능한 한 한 Section에만 두고, 이후 Section에서는 현재 질문에 필요한 만큼만 다시 연결합니다. 읽다가 용어가 다시 헷갈리면 [개념사전](../../reference/concept-glossary.md)과 그 항목에 적힌 대표 Section를 함께 확인하면 됩니다.
