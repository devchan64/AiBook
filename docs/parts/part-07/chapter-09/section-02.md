...
```mermaid
--8<-- "assets/part-07/chapter-09/p7-9-2-overclaim-case-flow-ko.mmd"
```

## 이번 실습에서 볼 실패 묶음

[P7-9.1](./section-01.md)과 같은 문서 집합을 그대로 쓰되, 질문 묶음을 더 넓혀 `통과`, `문서 범위 밖`, `검색 실패`, `답변 과장 위험`이 모두 나오게 만듭니다.
...
```mermaid
--8<-- "assets/part-07/chapter-09/p7-9-2-boundary-check-flow-ko.mmd"
```
...
- 문서 집합: [`p7-9-rag-documents.csv`](../../../assets/part-07/chapter-09/p7-9-rag-documents.csv) · [CSV 미리보기](../../../assets/part-07/chapter-09/p7-9-rag-documents.csv){ .csv-preview }
  - 역할: 직접 근거, 주변 설명, near miss 후보가 함께 섞인 공통 지식베이스
- 경계 사례 질문 묶음: [`p7-9-boundary-cases.csv`](../../../assets/part-07/chapter-09/p7-9-boundary-cases.csv) · [CSV 미리보기](../../../assets/part-07/chapter-09/p7-9-boundary-cases.csv){ .csv-preview }
...
- 확인할 개념:
  ...
  - 질문별 상태 기록이 있어야 P7-13의 운영 회고로 자연스럽게 넘어간다
...
읽은 경계 사례 파일 = docs/assets/part-07/chapter-09/p7-9-boundary-cases.csv
핵심 질문별 기록 =
