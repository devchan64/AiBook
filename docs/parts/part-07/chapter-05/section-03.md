...
![양팔을 벌린 정면 body-only OpenPose, 긴 허리·짧아진 다리·전체 키 10% 축소](../../../assets/part-07/chapter-05/sec-03/p7-5-3-openpose-fullbody-stage2-open-arms-short-long-legs-v7-yaw+00_pitch+00.png)

[정면 v7 OpenPose 좌표 JSON](/AiBook/assets/part-07/chapter-05/sec-03/p7-5-3-openpose-fullbody-stage2-open-arms-short-long-legs-v7-yaw+00_pitch+00.json)

[정면 v7 OpenPose result.json](/AiBook/assets/part-07/chapter-05/sec-03/p7-5-3-openpose-fullbody-stage2-open-arms-short-long-legs-v7-result.json)

[OpenPose 관계 맵 Python 생성기](/AiBook/assets/part-07/chapter-05/sec-03/p7_5_3_generate_openpose_turnaround_relation_maps.py){ .lazy-source }
...
![맨발 기본 의상을 생성한 새 1단계 10스텝 결과](../../../assets/part-07/chapter-05/sec-03/p7-5-3-qwen-edit-prompt-style-outfit_stage1_face_openpose-three-stage-v1-seed-62294-steps-10.png)

[새 1단계 입력·프롬프트·출력 기록](../../../assets/part-07/chapter-05/sec-03/p7-5-3-qwen-edit-prompt-style-outfit_stage1_face_openpose-three-stage-v1-seed-62294-steps-10-result.json){ .lazy-source }
...
![Qwen-Image-2512로 10스텝 생성한 흰색 로우탑 스니커즈 한 쌍](../../../assets/part-07/chapter-05/sec-03/p7-5-3-qwen-image-2512-white-sneakers-v1-size-1280x1280-seed-62294-steps-10.png)

[흰색 스니커즈 프롬프트·실행 조건·출력 기록](../../../assets/part-07/chapter-05/sec-03/p7-5-3-qwen-image-2512-white-sneakers-v1-size-1280x1280-seed-62294-steps-10-result.json){ .lazy-source }
...
[Qwen-Image-2512 신발 생성 코드](../../../assets/part-07/chapter-05/sec-03/p7_5_3_qwen_image_2512_generate_white_sneakers.py){ .lazy-source }

저장소 루트에서 다음 명령을 사용한다. `--dry-run`을 빼면 생성하며, 기존 출력이 있으므로 재실행에는 새 `--run-label`을 지정한다.

```bash
.venv/bin/python docs/assets/part-07/chapter-05/sec-03/p7_5_3_qwen_image_2512_generate_white_sneakers.py \
...
![2단계 흰색 스니커즈 추가 10스텝 결과](../../../assets/part-07/chapter-05/sec-03/p7-5-3-qwen-edit-prompt-style-outfit_stage2_shoes-three-stage-v1-seed-62294-steps-10.png)

[2단계 입력·프롬프트·출력 기록](../../../assets/part-07/chapter-05/sec-03/p7-5-3-qwen-edit-prompt-style-outfit_stage2_shoes-three-stage-v1-seed-62294-steps-10-result.json){ .lazy-source }
...
![3단계 열린 흰색 크롭 재킷 추가 10스텝 결과](../../../assets/part-07/chapter-05/sec-03/p7-5-3-qwen-edit-prompt-style-outfit_stage3_jacket_face-three-stage-v1-seed-62294-steps-10.png)

[3단계 입력·프롬프트·출력 기록](../../../assets/part-07/chapter-05/sec-03/p7-5-3-qwen-edit-prompt-style-outfit_stage3_jacket_face-three-stage-v1-seed-62294-steps-10-result.json){ .lazy-source }
...
[착장 1~3단계 생성기](/AiBook/assets/part-07/chapter-05/sec-03/p7_5_3_qwen_edit_outfit_stages.py){ .lazy-source }

기존 결과는 덮어쓰지 않으므로 사용하지 않은 `--run-label`을 지정한다.

```bash
.venv/bin/python docs/assets/part-07/chapter-05/sec-03/p7_5_3_qwen_edit_outfit_stages.py \
...
| −90° | −45° | 정면 | +45° | +90° |
| --- | --- | --- | --- | --- |
| ![저각 −90도 3단계 착장](../../../assets/part-07/chapter-05/sec-03/p7-5-3-qwen-outfit-stage3-vertical-low-yaw_minus_90-stage3-reference-v1-size-960x1440-seed-62294-steps-4.png) | ![저각 −45도 3단계 착장](../../../assets/part-07/chapter-05/sec-03/p7-5-3-qwen-outfit-stage3-vertical-low-yaw_minus_45-stage3-reference-v1-size-960x1440-seed-62294-steps-4.png) | ![저각 정면 3단계 착장](../../../assets/part-07/chapter-05/sec-03/p7-5-3-qwen-outfit-stage3-vertical-low-yaw_zero-stage3-reference-v1-size-960x1440-seed-62294-steps-4.png) | ![저각 +45도 3단계 착장](../../../assets/part-07/chapter-05/sec-03/p7-5-3-qwen-outfit-stage3-vertical-low-yaw_plus_45-stage3-reference-v1-size-960x1440-seed-62294-steps-4.png) | ![저각 +90도 3단계 착장](../../../assets/part-07/chapter-05/sec-03/p7-5-3-qwen-outfit-stage3-vertical-low-yaw_plus_90-stage3-reference-v1-size-960x1440-seed-62294-steps-4.png) |

[저각 −90° result.json](/AiBook/assets/part-07/chapter-05/sec-03/p7-5-3-qwen-outfit-stage3-vertical-low-yaw_minus_90-stage3-reference-v1-size-960x1440-seed-62294-steps-4-result.json)

[저각 −45° result.json](/AiBook/assets/part-07/chapter-05/sec-03/p7-5-3-qwen-outfit-stage3-vertical-low-yaw_minus_45-stage3-reference-v1-size-960x1440-seed-62294-steps-4-result.json)

[저각 정면 result.json](/AiBook/assets/part-07/chapter-05/sec-03/p7-5-3-qwen-outfit-stage3-vertical-low-yaw_zero-stage3-reference-v1-size-960x1440-seed-62294-steps-4-result.json)

[저각 +45° result.json](/AiBook/assets/part-07/chapter-05/sec-03/p7-5-3-qwen-outfit-stage3-vertical-low-yaw_plus_45-stage3-reference-v1-size-960x1440-seed-62294-steps-4-result.json)

[저각 +90° result.json](/AiBook/assets/part-07/chapter-05/sec-03/p7-5-3-qwen-outfit-stage3-vertical-low-yaw_plus_90-stage3-reference-v1-size-960x1440-seed-62294-steps-4-result.json)

### 아이레벨 5방향

| −90° | −45° | 정면 | +45° | +90° |
| --- | --- | --- | --- | --- |
| ![아이레벨 −90도 3단계 착장](../../../assets/part-07/chapter-05/sec-03/p7-5-3-qwen-outfit-stage3-vertical-level-yaw_minus_90-stage3-reference-v1-size-960x1440-seed-62294-steps-4.png) | ![아이레벨 −45도 3단계 착장](../../../assets/part-07/chapter-05/sec-03/p7-5-3-qwen-outfit-stage3-vertical-level-yaw_minus_45-stage3-reference-v1-size-960x1440-seed-62294-steps-4.png) | ![아이레벨 정면 3단계 착장](../../../assets/part-07/chapter-05/sec-03/p7-5-3-qwen-outfit-stage3-vertical-level-yaw_zero-stage3-reference-v1-size-960x1440-seed-62294-steps-4.png) | ![아이레벨 +45도 3단계 착장](../../../assets/part-07/chapter-05/sec-03/p7-5-3-qwen-outfit-stage3-vertical-level-yaw_plus_45-stage3-reference-v1-size-960x1440-seed-62294-steps-4.png) | ![아이레벨 +90도 3단계 착장](../../../assets/part-07/chapter-05/sec-03/p7-5-3-qwen-outfit-stage3-vertical-level-yaw_plus_90-stage3-reference-v1-size-960x1440-seed-62294-steps-4.png) |

[아이레벨 −90° result.json](/AiBook/assets/part-07/chapter-05/sec-03/p7-5-3-qwen-outfit-stage3-vertical-level-yaw_minus_90-stage3-reference-v1-size-960x1440-seed-62294-steps-4-result.json)

[아이레벨 −45° result.json](/AiBook/assets/part-07/chapter-05/sec-03/p7-5-3-qwen-outfit-stage3-vertical-level-yaw_minus_45-stage3-reference-v1-size-960x1440-seed-62294-steps-4-result.json)

[아이레벨 정면 result.json](/AiBook/assets/part-07/chapter-05/sec-03/p7-5-3-qwen-outfit-stage3-vertical-level-yaw_zero-stage3-reference-v1-size-960x1440-seed-62294-steps-4-result.json)

[아이레벨 +45° result.json](/AiBook/assets/part-07/chapter-05/sec-03/p7-5-3-qwen-outfit-stage3-vertical-level-yaw_plus_45-stage3-reference-v1-size-960x1440-seed-62294-steps-4-result.json)

[아이레벨 +90° result.json](/AiBook/assets/part-07/chapter-05/sec-03/p7-5-3-qwen-outfit-stage3-vertical-level-yaw_plus_90-stage3-reference-v1-size-960x1440-seed-62294-steps-4-result.json)
...
| −90° | −45° | 정면 | +45° | +90° |
| --- | --- | --- | --- | --- |
| ![엘리베이티드 −90도 3단계 착장](../../../assets/part-07/chapter-05/sec-03/p7-5-3-qwen-outfit-stage3-vertical-elevated-yaw_minus_90-stage3-reference-v1-size-960x1440-seed-62294-steps-4.png) | ![엘리베이티드 −45도 3단계 착장](../../../assets/part-07/chapter-05/sec-03/p7-5-3-qwen-outfit-stage3-vertical-elevated-yaw_minus_45-minus45-seed-test-v1-size-960x1440-seed-62295-steps-4.png) | ![엘리베이티드 정면 3단계 착장](../../../assets/part-07/chapter-05/sec-03/p7-5-3-qwen-outfit-stage3-vertical-elevated-yaw_zero-stage3-reference-v1-size-960x1440-seed-62294-steps-4.png) | ![엘리베이티드 +45도 3단계 착장](../../../assets/part-07/chapter-05/sec-03/p7-5-3-qwen-outfit-stage3-vertical-elevated-yaw_plus_45-stage3-reference-v1-size-960x1440-seed-62294-steps-4.png) | ![엘리베이티드 +90도 3단계 착장](../../../assets/part-07/chapter-05/sec-03/p7-5-3-qwen-outfit-stage3-vertical-elevated-yaw_plus_90-stage3-reference-v1-size-960x1440-seed-62294-steps-4.png) |

[엘리베이티드 −90° result.json](/AiBook/assets/part-07/chapter-05/sec-03/p7-5-3-qwen-outfit-stage3-vertical-elevated-yaw_minus_90-stage3-reference-v1-size-960x1440-seed-62294-steps-4-result.json)

[엘리베이티드 −45° result.json](/AiBook/assets/part-07/chapter-05/sec-03/p7-5-3-qwen-outfit-stage3-vertical-elevated-yaw_minus_45-minus45-seed-test-v1-size-960x1440-seed-62295-steps-4-result.json)

[엘리베이티드 정면 result.json](/AiBook/assets/part-07/chapter-05/sec-03/p7-5-3-qwen-outfit-stage3-vertical-elevated-yaw_zero-stage3-reference-v1-size-960x1440-seed-62294-steps-4-result.json)

[엘리베이티드 +45° result.json](/AiBook/assets/part-07/chapter-05/sec-03/p7-5-3-qwen-outfit-stage3-vertical-elevated-yaw_plus_45-stage3-reference-v1-size-960x1440-seed-62294-steps-4-result.json)

[엘리베이티드 +90° result.json](/AiBook/assets/part-07/chapter-05/sec-03/p7-5-3-qwen-outfit-stage3-vertical-elevated-yaw_plus_90-stage3-reference-v1-size-960x1440-seed-62294-steps-4-result.json)

[최초 15방향 실행 기록과 엘리베이티드 −45° 교체 경로](../../../assets/part-07/chapter-05/sec-03/p7-5-3-qwen-outfit-stage3-yaw-batch-stage3-reference-v1-size-960x1440-seed-62294-steps-4-result.json){ .lazy-source }
...
[전신 착장 15방향 회전 Python 생성기](/AiBook/assets/part-07/chapter-05/sec-03/p7_5_3_qwen_rotate_fullbody_outfit.py){ .lazy-source }
...
![3단계 전신과 정면 토르소 기준으로 생성한 2511 앨리웁 동작](../../../assets/part-07/chapter-05/sec-03/p7-5-3-qwen-edit-2511-fullbody-alley-oop-stage3-reference-v1-size-1024x1536-seed-62294-steps-20.png)

[2511 앨리웁 1024×1536, 20-step result.json](/AiBook/assets/part-07/chapter-05/sec-03/p7-5-3-qwen-edit-2511-fullbody-alley-oop-stage3-reference-v1-size-1024x1536-seed-62294-steps-20-result.json)
...
[앨리웁 전신 Python 생성기](/AiBook/assets/part-07/chapter-05/sec-03/p7_5_3_qwen_edit_fullbody_alley_oop.py){ .lazy-source }
...
![흰 스니커즈의 왼쪽 윗면과 오른쪽 바닥면 20스텝 결과](../../../assets/part-07/chapter-05/sec-03/p7-5-3-qwen-2511-white-sneaker-outsole-upper-bottom-v3-size-1280x1280-seed-62294-steps-20.png)

[신발 윗면·바닥면 입력·프롬프트·결과 기록](../../../assets/part-07/chapter-05/sec-03/p7-5-3-qwen-2511-white-sneaker-outsole-upper-bottom-v3-size-1280x1280-seed-62294-steps-20-result.json){ .lazy-source }
...
[신발 윗면·바닥면 생성 코드](../../../assets/part-07/chapter-05/sec-03/p7_5_3_qwen_edit_2511_generate_shoe_outsole.py){ .lazy-source }

같은 폴더의 공통 경로·이미지 전처리·해시 함수를 가져오므로 재실행할 때 함께 유지한다.

```bash
.venv/bin/python docs/assets/part-07/chapter-05/sec-03/p7_5_3_qwen_edit_2511_generate_shoe_outsole.py \
