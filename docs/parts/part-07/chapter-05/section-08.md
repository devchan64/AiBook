...
관절 맵 준비 코드는 `--reference-image`로 지정한 인물 이미지에서 몸의 관절 맵을 추출한다. `--output`을 생략하면 `sec-08/p7-5-8-openpose-body-reference.png`에 저장한다. 로컬 캐시에 OpenPose 검출 모델이 필요하며, 아래 기존 SDXL 비교 결과를 생성하는 단계는 포함하지 않는다.

[OpenPose 관절 맵 준비 코드](../../../assets/part-07/chapter-05/sec-08/p7_5_8_prepare_openpose_maps.py)
...
![저장 우측 쿼터 OpenPose map과 ControlNet off/on 산출물](../../../assets/part-07/chapter-05/sec-08/p7-5-8-openpose-static-quarter-right-contact-sheet.png)
...
![선언형 OpenPose map ControlNet off/on](../../../assets/part-07/chapter-05/sec-08/p7-5-8-openpose-declarative-reach-up-controlnet-ab-contact-sheet.png)
...
[저장 관절 맵 비교 기록 — JSON](/AiBook/assets/part-07/chapter-05/sec-08/p7-5-8-openpose-static-quarter-right-report.json)

[팔 올리기 맵 비교 기록 — JSON](/AiBook/assets/part-07/chapter-05/sec-08/p7-5-8-openpose-declarative-reach-up-controlnet-ab-report.json)
...
![SDXL 전신 safe-face 조건의 OpenPose off/on 비교](../../../assets/part-07/chapter-05/sec-08/p7-5-8-sdxl-safe-face-openpose-ab-contact-sheet.png)

![SDXL safe-face 전신 후보와 기준 얼굴 비교](../../../assets/part-07/chapter-05/sec-08/p7-5-8-sdxl-safe-face-contact-sheet.png)
...
[전신 생성 — OpenPose 끔 실행 기록 — JSON](/AiBook/assets/part-07/chapter-05/sec-08/p7-5-8-sdxl-safe-face-without-openpose-960x1440-result.json)

[전신 생성 — OpenPose 켬 실행 기록 — JSON](/AiBook/assets/part-07/chapter-05/sec-08/p7-5-8-sdxl-safe-face-with-openpose-960x1440-result.json)

### 카메라 문구만으로 고각도 구도가 만들어지지 않았다

팔을 올리는 동작을 그대로 두고, 위에서 내려다보는 시점인 `high-angle`을 프롬프트에 추가했다.

![선언형 OpenPose map에서 카메라 문구를 바꾼 비교](../../../assets/part-07/chapter-05/sec-08/p7-5-8-openpose-declarative-reach-up-camera-ab-contact-sheet.png)
...
[카메라 문구 비교 기록 — JSON](/AiBook/assets/part-07/chapter-05/sec-08/p7-5-8-openpose-declarative-reach-up-camera-ab-report.json)

### 배경 원근은 일부 남았지만 인물과 동작이 달라졌다

다음 실험에서는 위에서 내려다본 공간을 가진 안내 이미지(guide)를 먼저 만들었다. 아래 이미지는 Animagine으로 만든 익명 인물의 고각도 장면이다.

![익명 인물로 만든 고각도 보행 guide](../../../assets/part-07/chapter-05/sec-08/p7-5-8-experimental-animagine-high-angle-guide.png)
...
![익명 guide·OpenPose·인물 제외 배경 Canny와 SDXL Mira 전이 후보](../../../assets/part-07/chapter-05/sec-08/p7-5-8-sdxl-anonymous-high-angle-transfer-review-sheet.png)
...
[고각도 장면 전이 실행 결과 — JSON](/AiBook/assets/part-07/chapter-05/sec-08/p7-5-8-sdxl-anonymous-high-angle-transfer-result.json)

[고각도 장면 전이 비교 조건 — JSON](/AiBook/assets/part-07/chapter-05/sec-08/p7-5-8-sdxl-anonymous-high-angle-transfer-report.json)
