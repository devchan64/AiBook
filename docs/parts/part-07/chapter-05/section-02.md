...
- 문서 집합: [`p7-5-rag-documents.csv`](../../../assets/part-07/chapter-05/p7-5-rag-documents.csv) · [CSV 미리보기](../../../assets/part-07/chapter-05/p7-5-rag-documents.csv){ .csv-preview }
  - 역할: 직접 근거, 주변 설명, near miss 후보가 함께 섞인 공통 지식베이스
- 경계 사례 질문 묶음: [`p7-5-boundary-cases.csv`](../../../assets/part-07/chapter-05/p7-5-boundary-cases.csv) · [CSV 미리보기](../../../assets/part-07/chapter-05/p7-5-boundary-cases.csv){ .csv-preview }
