...
Part 7 앞 절들은 서로 다른 실행 장면을 다룹니다. P7-2에서는 비교 실험, P7-4에서는 학습 로그, P7-5에서는 RAG 검색 근거, P7-6에서는 AI 에이전트 실행 기록, P7-7 앞 절에서는 배포와 운영 회고를 다뤘습니다. 그런데 실제 프로젝트에서는 이 기록들이 한 폴더나 문서 묶음 안에서 다시 실행 가능해야 합니다.
