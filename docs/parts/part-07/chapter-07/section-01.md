# P7-7.1 SAM 2로 이미지 입력 prompt와 segmentation 결과 비교하기
...
image_file = "inputs/p7-7-1-desk-object.jpg"
...
```text
p7-7-1-desk-object-point-mask.png
p7-7-1-desk-object-box-mask.png
```
