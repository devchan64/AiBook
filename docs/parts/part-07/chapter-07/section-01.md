...
```mermaid
--8<-- "assets/part-07/chapter-07/p7-7-1-triage-case-flow-ko.mmd"
```

## 프로젝트 흐름

```mermaid
--8<-- "assets/part-07/chapter-07/p7-7-1-agent-loop-flow-ko.mmd"
```
...
- 파일 경로: [`p7-7-agent-triage-steps.csv`](../../../assets/part-07/chapter-07/p7-7-agent-triage-steps.csv) · [CSV 미리보기](../../../assets/part-07/chapter-07/p7-7-agent-triage-steps.csv){ .csv-preview }
...
data_path = Path("docs/assets/part-07/chapter-07/p7-7-agent-triage-steps.csv")
...
```text
읽은 파일 = docs/assets/part-07/chapter-07/p7-7-agent-triage-steps.csv
목표 = 결제 API 장애 티켓을 읽고 안전한 다음 행동을 정리한다
