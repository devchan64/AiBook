...
P7-13.3에서는 운영 신호를 `즉시 수정`, `재현 확인`, `다음 반복 개선`으로 나눴습니다. 이 구분은 첫 행동을 정하는 데 좋습니다. 하지만 운영 신호가 계속 쌓이면 같은 행동 구간 안에서도 다시 순서를 정해야 합니다.
...
```mermaid
--8<-- "assets/part-07/chapter-13/p7-13-4-alert-grade-flow-ko.mmd"
```

## 입력 파일

- 파일 경로: [`p7-13-action-unit-alert-grades.csv`](../../../assets/part-07/chapter-13/p7-13-action-unit-alert-grades.csv) · [CSV 미리보기](../../../assets/part-07/chapter-13/p7-13-action-unit-alert-grades.csv){ .csv-preview }
...
data_path = Path("docs/assets/part-07/chapter-13/p7-13-action-unit-alert-grades.csv")
...
- 경고 등급 설계 파일: [`p7-13-action-unit-alert-grades.csv`](../../../assets/part-07/chapter-13/p7-13-action-unit-alert-grades.csv) · [CSV 미리보기](../../../assets/part-07/chapter-13/p7-13-action-unit-alert-grades.csv){ .csv-preview }
