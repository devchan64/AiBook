...
P7-1.1에서는 운영 로그를 읽고 평균, 최대값, 비율을 계산해 기본 관찰을 만들었습니다. 이제는 그 결과를 baseline과 나란히 놓고 첫 비교를 어떻게 남길지가 더 중요해집니다. 이 절은 바로 그 질문을 정리합니다. baseline과 첫 비교는 숫자를 다시 적는 절이 아니라, 무엇을 확인했고 무엇은 아직 가설인지 구분해 남기는 단계입니다.
...
방금 앞 절의 출력과 결과 해석 표를 다시 읽으면, 이 세 칸이 어디에서 나오는지도 자연스럽게 보입니다.
