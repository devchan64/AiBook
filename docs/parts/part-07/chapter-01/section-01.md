...
프로젝트 질문은 `project_question`, `sample_unit`, `input_source`, `target_or_output`, `baseline_scope`, `record_owner`를 먼저 남기며 시작합니다. 이 기록이 있어야 Part 3의 샘플·target 기준이 실습 데이터 준비로 바로 이어집니다.
