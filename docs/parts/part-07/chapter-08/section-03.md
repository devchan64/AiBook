...
P7-8.2까지 읽으면 실패 기록은 남길 수 있습니다. 하지만 실제 운영에서는 거기서 한 단계 더 나아가 `그래서 지금 무엇부터 할 것인가`를 빠르게 정해야 합니다.
...
```mermaid
--8<-- "assets/part-07/chapter-08/p7-8-3-incident-priority-flow-ko.mmd"
```
...
- 파일 경로: [`p7-8-ops-scenarios.csv`](../../../assets/part-07/chapter-08/p7-8-ops-scenarios.csv) · [CSV 미리보기](../../../assets/part-07/chapter-08/p7-8-ops-scenarios.csv){ .csv-preview }
...
```mermaid
--8<-- "assets/part-07/chapter-08/p7-8-3-ops-review-flow-ko.mmd"
```
...
data_path = Path("docs/assets/part-07/chapter-08/p7-8-ops-scenarios.csv")
...
읽은 파일 = docs/assets/part-07/chapter-08/p7-8-ops-scenarios.csv
운영 판단 기록 =
...
- 운영 시나리오 파일: [`p7-8-ops-scenarios.csv`](../../../assets/part-07/chapter-08/p7-8-ops-scenarios.csv){ .csv-preview }
