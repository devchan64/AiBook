...
```mermaid
--8<-- "assets/part-07/chapter-08/p7-8-1-status-reading-flow-ko.mmd"
```
...
```mermaid
--8<-- "assets/part-07/chapter-08/p7-8-1-deployment-path-flow-ko.mmd"
```
...
배포 확인표를 표로만 읽고 끝내지 않으려면, 같은 형식을 실제 점검 기록 파일로도 다뤄 보는 편이 좋습니다. Python 예제에서는 배포 확인표 두 건을 [`p7-8-deployment-checks.csv`](../../../assets/part-07/chapter-08/p7-8-deployment-checks.csv) · [CSV 미리보기](../../../assets/part-07/chapter-08/p7-8-deployment-checks.csv){ .csv-preview }에 두고, 코드가 그 기록을 읽어 `공개 확인까지 끝난 배포`와 `재확인이 필요한 배포`를 구분합니다.
...
- 파일 경로: [`p7-8-deployment-checks.csv`](../../../assets/part-07/chapter-08/p7-8-deployment-checks.csv) · [CSV 미리보기](../../../assets/part-07/chapter-08/p7-8-deployment-checks.csv){ .csv-preview }
...
data_path = Path("docs/assets/part-07/chapter-08/p7-8-deployment-checks.csv")
...
```text
읽은 파일 = docs/assets/part-07/chapter-08/p7-8-deployment-checks.csv
배포별 요약 =
