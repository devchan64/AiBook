# P7-8.1 Whisper와 MusicGen으로 음성·오디오 모델 입출력 비교하기
...
```bash
whisper inputs/p7-8-1-clean.wav --model tiny --language Korean
whisper inputs/p7-8-1-clean.wav --model small --language Korean
whisper inputs/p7-8-1-noisy.wav --model small --language Korean
```
...
result = model.transcribe("inputs/p7-8-1-noisy.wav", language="ko")
print(result["text"])
```
