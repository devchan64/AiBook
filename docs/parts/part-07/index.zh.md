...
这张对应表之所以重要，是因为 Part 7 不是额外拉出一大段新理论的 Part，而是把 `问题设定 -> 比较 -> 结构解释 -> 执行记录 -> 运营回顾` 绑成一条实作流程的 Part。只要先把当前卡住的点分成比较设计问题、结构或学习解释问题、或者依据、工具、运营问题，下一步该重开的节也会快得多。

## 实作记录的共同节奏

即使每一节的代码块不同，Part 7 的执行记录大体上也会按相近的节奏留下来。
