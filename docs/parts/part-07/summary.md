...
대표 Section을 다시 열 때는 설명만 다시 읽지 말고 같은 역할의 실습 지점까지 같이 확인합니다. 예를 들어 비교 실험이 막히면 `P7-2.3`, 표현 정보 손실이 막히면 `P7-4.4`, 운영 등급 판단이 막히면 `P7-7.4`, 실행 인수인계가 막히면 `P7-7.5`에서 값을 바꿔 본 뒤 회고 문장을 다시 적는 방식으로 복귀할 수 있습니다.
