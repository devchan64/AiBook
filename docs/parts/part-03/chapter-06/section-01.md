...
이 절은 Part 3 안에서 `특징(feature)`을 비교 가능한 구조로 설계하는 대표 설명 위치입니다. 뒤 절에서 중간 표현을 더 두는 경우를 보더라도, 먼저 어떤 구조를 숫자 특징으로 남길 것인지는 여기와 [개념사전](../../../reference/concept-glossary.md)으로 다시 돌아오면 됩니다.
