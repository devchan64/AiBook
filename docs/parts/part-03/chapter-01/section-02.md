...
즉 Part 3에서 이 흐름을 먼저 세우는 이유는, 뒤 설명이 앞 판단을 자주 전제로 하기 때문입니다. 가장 흔한 실패는 `모델을 먼저 고른 뒤 나중에 샘플 단위를 끼워 맞추는 경우`입니다. 이런 경우에는 나중에 표를 다시 만들고 특징을 다시 뽑고 출력 구조까지 다시 정의해야 해서, 앞에서 판단 기준을 정리해 두는 편이 오히려 덜 흔들립니다.
