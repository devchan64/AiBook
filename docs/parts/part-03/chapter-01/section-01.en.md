...
As soon as the reader enters Part 3, they meet words such as [sample](/AiBook/en/reference/concept-glossary-alpha/t/#glossary-sample), [feature](/AiBook/en/reference/concept-glossary-alpha/t/#glossary-feature), [baseline](/AiBook/en/reference/concept-glossary-alpha/b/#glossary-baseline), [output structure](/AiBook/en/reference/concept-glossary-alpha/o/#glossary-output-structure), and [target](/AiBook/en/reference/concept-glossary-alpha/t/#glossary-target). These terms do not stand alone. The outer judgment that decides what counts as one case, which values remain, what gets compared, and in what result format the process closes is [data modeling](/AiBook/en/reference/concept-glossary-alpha/d/#glossary-data-modeling).
