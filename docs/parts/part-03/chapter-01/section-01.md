...
5. Part 3에서는 이 모든 흐름의 바닥에 있는 데이터, 모델, 학습, 평가를 먼저 봅니다.
...
이 절이 AI, 머신러닝, 딥러닝, 생성형 AI, LLM의 포함 관계를 따로 잡는 이유가 여기에 있습니다. LLM 경험은 현대 AI 이해의 중요한 출발점이지만, AI 전체를 대표하는 하나의 이름으로 놓으면 Part 3에서 다시 볼 데이터, 모델, 학습, 평가 흐름이 가려집니다.
