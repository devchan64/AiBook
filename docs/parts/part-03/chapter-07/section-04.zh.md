...
因此，这一节与其说是一份现场规则清单，不如说更准确地是在讨论：[怎样选出一个可比较的参考群体(selecting a comparable reference group)](/AiBook/zh/reference/concept-glossary-pinyin/k/#glossary-comparable-reference-group)。所谓选基准线，不是 `挑一个过去平均值`，而是按条件一步步收窄到一个真正可和当前样本比较的参考群体。
