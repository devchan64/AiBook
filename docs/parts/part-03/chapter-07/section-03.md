...
예를 들어 최근 20건의 평균 유량이 2.1이고 [기준선 구간(baseline window)](../../../reference/concept-glossary-parts/01-giyeok.md#glossary-baseline-window) 평균이 2.45라면, 우리는 먼저 `-0.35의 차이`를 읽습니다. 이 차이는 아직 모델 성능이 아니라, 상태 비교 결과입니다.
