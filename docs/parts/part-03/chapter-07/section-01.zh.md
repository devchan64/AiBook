...
因此，这一节与其说是在介绍“基准线”这个词，不如说更准确地是在讨论：为了读取当前状态，应该把什么样的 [参考区间(reference window)](/AiBook/zh/reference/concept-glossary-pinyin/b/#baseline) 一起放进来。基准线不是多出来的一串数字，而是一个参考区间，它把当前结构从“单独一个值”变成 `可比较的状态`。
