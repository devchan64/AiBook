...
이 절은 Part 3 안에서 `기준선 비교 구조`를 가장 먼저 고정하는 대표 설명 위치입니다. 뒤 절에서 비교표를 사람 검토 문장으로 읽는 순서를 다루더라도, 먼저 무엇을 무엇과 비교하는 구조를 세우는 일 자체는 여기와 [개념사전](../../../reference/concept-glossary.md)에 둡니다.
...
다음 질문에 답할 수 있으면, 이 절의 기준선 설계 기준은 잡힌 것입니다.
