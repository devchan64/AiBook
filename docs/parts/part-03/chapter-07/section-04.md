...
| 최근 20건 집계 표 | 같은 조건과 집계 규칙을 쓴 충분한 과거 동작 묶음 | 건수 3건짜리 작은 묶음 |
...
최근 20건과 과거 200건을 비교할 수도 있습니다. 같은 건수보다 같은 샘플 정의와 계산 방식이 중요하며, 두 건수는 따로 적어야 합니다. 또한 최근 평균과 비슷하다는 이유로 과거 구간을 고르면 관찰하려는 차이를 스스로 지울 수 있습니다. 후보 조건은 결과를 본 뒤 편의적으로 고르지 않습니다. 정비 효과를 묻는 문제라면 정비 전후를 나눠 비교할 수 있지만, 그때는 다른 운전 조건 변화도 함께 확인해야 합니다.

## 조건에 맞는 기준선 후보 좁히기 {#_4}
...
- 기준선 후보의 운전 조건과 기간을 선택한 이유를 썼는가?
- 현재 평균과 비슷하다는 이유로 기준선을 고르면 생기는 문제를 설명했는가?
