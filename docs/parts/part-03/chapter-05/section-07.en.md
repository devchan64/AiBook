...
| Whether the folded result is for reporting or a prediction candidate | To avoid mixing comparison reports with [target candidates](/AiBook/en/reference/concept-glossary-alpha/t/#glossary-target-candidate) |
