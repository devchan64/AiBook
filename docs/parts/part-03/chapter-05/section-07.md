...
| 접은 결과가 보고용인지 예측 후보용인지 | 비교 리포트와 [목표 라벨 후보(target candidate)](../../../reference/concept-glossary-parts/05-mieum.md#glossary-target-candidate)를 섞지 않기 위해 |
