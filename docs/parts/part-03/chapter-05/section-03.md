...
원시 시계열을 보면 많은 독자가 이렇게 생각합니다. `값도 많고 순서도 있으니, 이걸 그냥 학습 입력으로 넘기면 되지 않을까?` 하지만 여기서 한 번 멈춰야 합니다. 원시 시계열이 있다는 사실만으로 아직 바로 [학습 입력(input)](../../../reference/concept-glossary-parts/08-ieung.md#glossary-input)이 준비되었다고 말할 수는 없기 때문입니다.
...
| [목표 라벨 후보(target candidate)](../../../reference/concept-glossary-parts/05-mieum.md#glossary-target-candidate) | 무엇을 맞히고 싶은지 정해야 하기 때문 |
