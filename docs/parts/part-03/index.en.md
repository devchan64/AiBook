...
Within Part 3, the larger definition of `data modeling` itself is first fixed in 3.1, and the working sequence is fixed in 3.2. Later sections keep only the minimum connection needed for the current question rather than repeating long definitions of the same term. [Sample](/AiBook/reference/concept-glossary/#glossary-sample), [feature](/AiBook/reference/concept-glossary/#glossary-feature), [baseline](/AiBook/reference/concept-glossary/#glossary-baseline), [comparison report](/AiBook/reference/concept-glossary/#glossary-comparison-report), and [target](/AiBook/reference/concept-glossary/#glossary-target) can be checked again in the glossary when needed.
...
- W3C, `PROV-Overview`. Because it treats provenance and derivation together, it supports the common premise of Part 3 that when source data is rebuilt into problem-representation structures, the rules that produced derived tables must remain traceable. [https://www.w3.org/TR/prov-overview/](https://www.w3.org/TR/prov-overview/){: target="_blank" rel="noopener noreferrer" } / Accessed: 2026-07-08
