...
이 도식은 문장을 쓰는 순서 자체가 핵심이라는 점을 보여 줍니다. 비교 결과를 먼저 말하고, 그다음 강도 조건을 붙이고, 마지막에 다음 행동으로 닫아야 과장과 공백이 함께 줄어듭니다. 즉 조건문 구현보다 `비교 결과 -> 강도 조건 -> 다음 행동` 골격을 먼저 잡는 일이 중요합니다.


여기서 중요한 것은 `문장을 약하게 쓰는 법`이 아니라 `근거가 직접 지지하는 순서로 문장을 배치하는 법`입니다.

문장 강도가 정리되어 있지 않으면, 비교 결과를 적는 문장 안에 원인 확정이나 과도한 판단이 쉽게 섞여 들어갑니다. 그러면 실제로 관측한 차이, 그 차이를 얼마나 강하게 말할 수 있는지, 사람이 무엇을 해야 하는지가 한 문장 안에서 뒤엉키기 쉽습니다.

그래서 여기서 먼저 고정해야 하는 것은 `비교 결과 -> 강도 조건 -> 다음 행동`의 순서입니다. 이 순서가 서 있어야 보고 문장은 비교 근거를 잃지 않고, 아직 없는 원인 판단을 미리 끌어오지도 않게 됩니다.
