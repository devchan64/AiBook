...
| 확신 강도 조절 | 표본 수와 반복성에 맞춰 얼마나 세게 말할지 조절한다 |
| 다음 행동 연결 | 사람이 무엇을 해야 하는지 운영 문장으로 닫는다 |
...
그래서 Chapter 8에서 너무 세게 말하지 않는 법을 문장 수준으로 먼저 고정해 두어야, Chapter 9의 산출물 구분도 더 자연스럽게 읽힙니다.
