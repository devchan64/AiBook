...
초심자가 이 절에서 가장 먼저 붙잡아야 할 질문은 다음 세 가지입니다.
...
초심자 기준에서는 다음 표가 특히 중요합니다.

| 보이는 장면 | 초심자가 하기 쉬운 오해 | baseline이 해 주는 일 |
| --- | --- | --- |
...
초심자가 이 예제에서 꼭 읽어야 할 것은 숫자 크기 하나가 아닙니다.
