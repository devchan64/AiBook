...
Chapter 9의 `경고`, `검토 후보`, `라벨 예측` 구분도 이 단계 위에서 읽어야 자연스럽습니다. 그 앞에서 이미 비교표를 읽고, 문장 강도를 조절하고, 그것을 운영 열로 다시 옮기는 과정이 있기 때문입니다.

보수적 해석 문장은 비교 결과를 운영 출력으로 옮기기 전 마지막 사람 판단 단계입니다. 이렇게 읽어 두어야 Chapter 9의 경고, 검토 후보, 라벨 예측 구분도 같은 구조화 과정을 이어받는 것으로 이해할 수 있습니다.
