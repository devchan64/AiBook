...
이 절은 입문적으로 `클러스터링이 어떤 질문에 답하는가`를 이해하는 데 집중합니다. 결과 해석의 주의점은 P3-17.2에서 이어서 다룹니다.
...
이 코드는 실제 클러스터링 알고리즘이 아닙니다. 하지만 초심자에게 중요한 감각을 줍니다.
