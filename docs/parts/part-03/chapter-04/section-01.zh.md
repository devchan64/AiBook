...
读数据时最先要确认的，不是数值大小，而是一[行(row)](/AiBook/zh/reference/concept-glossary-pinyin/h/#glossary-row)到底表示什么。如果这个问题没有先定下来，那么后面做[特征(feature)](/AiBook/zh/reference/concept-glossary-pinyin/f/#glossary-feature)、贴[标签(label)](/AiBook/zh/reference/concept-glossary-pinyin/l/#glossary-label)、读[评估(evaluation)](/AiBook/zh/reference/concept-glossary-pinyin/e/#glossary-evaluation)结果时，标准都会一起晃动。归根到底，这个问题会继续追到什么应该算一条可比较[样本(sample)](/AiBook/zh/reference/concept-glossary-pinyin/y/#glossary-sample)。
