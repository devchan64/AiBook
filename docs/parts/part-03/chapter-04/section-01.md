...
이 절은 Part 3 안에서 `한 행`과 `샘플 1건`의 차이를 가장 먼저 고정하는 대표 설명 위치입니다. 뒤 절에서 샘플 단위가 흔들릴 때의 파급효과를 보더라도, 먼저 어떤 표에서 한 행이 무엇을 뜻하는지 구분하는 큰 축은 여기와 [개념사전](../../../reference/concept-glossary.md)으로 다시 돌아오면 됩니다.
