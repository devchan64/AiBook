...
앞 장까지의 비교표가 이번 장에서 어떤 산출물로 갈라지는지도 먼저 적어 둘 수 있습니다.

| 이전 Chapter에서 남긴 것 | 이번 Chapter에서 추가로 정하는 것 | 이 장 끝에 남는 구조 |
| --- | --- | --- |
| 차이값, 기준선, 반복성, 해석 강도 조건이 있는 비교표 | 지금 문제를 경고, 검토 후보, 라벨 예측 중 어디까지 올릴지 | 문제 승격 경계와 산출물 구분 |
