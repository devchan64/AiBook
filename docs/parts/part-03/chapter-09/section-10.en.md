...
| --- | --- |
| [Delayed label confirmation](/AiBook/en/reference/concept-glossary-alpha/s/#supervised-learning-label) | The result existed, but when does it close as the final answer? |
