# P5-19.1 작은 생성형 AI 기능을 한 흐름으로 묶기

P5-18장까지 오면 LLM, RAG, 도구 사용, 에이전트, 평가, 실패 대응을 각각 따로 설명할 수는 있게 됩니다. 하지만 여기서 한 번 더 중요한 질문이 남습니다.
...
이 질문은 P5-19.2 최소 구현과 회고 포인트로 이어집니다.
