...
이 문장은 맞지만, 너무 짧으면 오해를 부릅니다. 많은 독자는 이 말을 듣고 `그럼 단순 자동완성 아닌가?`라고 생각합니다. 이 절의 목적은 바로 그 질문을 더 정확한 수준으로 정리하는 데 있습니다.
...
이 절의 목적은 `LLM의 기본 학습 목표`를 독자도 설명할 수 있게 만드는 것입니다.
