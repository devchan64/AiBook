...
여기서 한 단계만 더 나가면, 자동 평가와 사람 평가의 결과는 곧바로 다음 장의 운영 판단 입력이 됩니다. 즉, 이 절의 끝은 `품질 판단 완료`가 아니라 `운영에서 어떤 후보를 계속 살리고 어떤 후보를 멈출지 정리된 상태`에 가깝습니다.
...
즉, 자동 평가와 사람 평가는 `좋다/나쁘다`를 말하고 끝나는 절차가 아니라, 다음 장에서 `운영 한도 안에 둘 후보`, `사람에게 다시 넘길 후보`, `실패 원인을 더 추적할 후보`를 나누는 기준선입니다.
