...
여기서 먼저 남겨야 할 것은 어떤 축에서 통과했고 어떤 축에서 탈락했는지를 보여 주는 축별 점수, `answer_status`, 수정 메모와, 무엇을 먼저 고쳐야 하는지를 보여 주는 `review_summary`, 우선 수정 항목입니다. 이 기록이 있어야 사람 검토와 운영 조치를 나눌 수 있고, 뒤로 갈수록 P5-15.2의 자동/사람 평가 분담, P5-16.1, P5-16.2의 운영 판단, Part 6의 `review_summary`, `answer_status`, `improvement_plan`, 회고 문서로 다시 읽힙니다.
