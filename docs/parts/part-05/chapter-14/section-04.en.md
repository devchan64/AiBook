# P5-14.4 How Do Residual And Normalization Stabilize Deep Repetition?

> Section ID: `P5-14.4`
> Version: `v2026.07.19`

In P5-14.3, we saw how the current representation moves through attention and feed-forward. But a Transformer block does not only keep stacking new computation. It also has stabilization devices that leave the original representation and organize the value range.
