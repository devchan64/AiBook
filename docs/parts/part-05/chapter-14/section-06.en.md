...
When the terms scatter again, it is useful to reread the [feed-forward network](/AiBook/en/reference/concept-glossary-alpha/t/#transformer) glossary entry together with the four-component role division in P5-14.2.
