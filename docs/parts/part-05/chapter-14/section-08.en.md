...
When the terminology begins to scatter again, revisit the [layer normalization](/AiBook/en/reference/concept-glossary-alpha/t/#transformer) entry in the concept glossary together with the four-part role split from P5-14.2.
