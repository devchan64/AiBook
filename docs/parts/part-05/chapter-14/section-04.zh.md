# P5-14.4 residual 和 normalization 怎样稳定深层重复？

> Section ID: `P5-14.4`
> Version: `v2026.07.19`

在 P5-14.3 中，我们看到了当前表示怎样经过 attention 和 feed-forward 移动。但是 Transformer block 不只是不断堆叠新计算。它还同时放入稳定化装置：留下原始表示，并整理数值范围。
