...
도구 사용의 기본 구조는 여기서 잡고, 구조화된 호출 형식은 바로 다음 P5-14.2 함수 호출에서 다시 회수합니다. 여러 단계 반복 구조는 P5-15.1 에이전트와 P5-15.2 계획, 행동, 관찰에서 다시 다루며, 권한과 운영 문제는 P5-16.2 하네스와 P5-18.2 운영 중 실패 대응에서 이어집니다.
