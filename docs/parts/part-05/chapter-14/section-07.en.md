...
When the terminology begins to scatter again, it helps to revisit the [residual connection](/AiBook/en/reference/concept-glossary-alpha/r/#residual-connection) entry in the concept glossary together with the four-part role split from P5-14.2.
