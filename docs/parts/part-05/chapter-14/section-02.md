...
테스트 프레임워크 세부 구현은 여기서 다루지 않고, 품질 점검의 큰 흐름만 남깁니다. 품질 점검은 뒤의 P5-15.1 LLM 평가와 P5-15.2 자동 평가와 사람 평가에서 다시 회수합니다. 운영 제약과 실패 대응은 P5-16.1, P5-16.2에서 다시 이어지며, 특정 관측성 스택과 배포 파이프라인 구현은 현재 본편 범위 밖에 둡니다.
