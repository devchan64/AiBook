...
처음 읽은 뒤에는 이 경계만 다시 말할 수 있어도 충분합니다. 실패 대응은 평가 다음에 `어디서 멈추고 어디로 복구할까`를 고르는 운영 복구 구조입니다. 핵심은 오류 자체보다 `복구 경로와 다음 조치`를 함께 남기는 데 있고, P5-17에서는 이 판단을 실제 요청 흐름과 기록으로 묶습니다.
