...
| --- | --- | --- | --- |
| 자동 평가와 사람 평가 | 이 답을 품질 기준으로 통과시킬 수 있는가? | P5-15.1, P5-15.2 |
| 운영 실패 대응 | 실패가 났을 때 retry, fallback, stop, approval 중 어디로 보낼 것인가? | P5-16.2 |
| 통합 미니 실습과 회고 | 이 판단과 기록을 실제 요청 흐름에 어떻게 남길 것인가? | P5-17.1, P5-17.2 |
