...
전체 모델을 다시 조정할 때의 비용 문제는 바로 다음 P5-9.2 LoRA와 효율적 조정에서 다시 회수합니다. 프롬프트, RAG, 도구 사용과의 선택 문제는 뒤의 P5-11.2 프롬프트의 한계와 P5-12.1 RAG의 필요성에서 이어지며, optimizer와 분산 학습 구현 세부는 현재 본편 범위 밖으로 둡니다.
