...
초심자는 먼저 다음 세 질문으로 읽으면 이해가 빨라집니다.
...
이 문장은 실무에서 중요합니다. 많은 초심자가 `우리 데이터로 조금 더 학습시키면 다 해결되겠지`라고 생각하기 쉽기 때문입니다. 실제로는 최신 정보 연결, 근거 제시, 권한 통제는 별도 설계가 필요합니다.
