...
When you need to review shape and computation units again in a short form, return to the glossary entries on [batch](../../../reference/concept-glossary.md#batch) and [tensor](../../../reference/concept-glossary.md#tensor).
