...
이 절의 목적은 후속 장의 세부 기술을 대신 설명하는 데 있지 않습니다. 오히려 `무엇을 어디서 먼저 손봐야 하는가`를 구분하는 판단 기준을 주는 데 있습니다. 프롬프트 조정은 P5-9.1, P5-9.2에서, 근거 연결은 P5-10.1, P5-10.2와 P5-11.1, P5-11.2에서, 실행 연결은 P5-12.1, P5-12.2와 P5-13.1, P5-13.2에서 다시 구체화합니다. 비용 비교표, 파인튜닝 파이프라인 전체, 조직별 운영 프로세스의 세부 설계는 현재 본편 범위 밖으로 둡니다.
