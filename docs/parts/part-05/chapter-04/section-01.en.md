...
When the role of loss needs to be checked again briefly in later sections, return to the [loss function](/AiBook/reference/concept-glossary-parts/07-siot/#loss-function) entry in the concept glossary.
