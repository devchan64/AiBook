...
![제곱오차와 cross-entropy 손실 모양](../../../assets/part-05/chapter-04/loss-shapes-ko.svg)

이 그래프의 목적은 공식을 외우는 것이 아니라, `어떤 축에서 멀어질 때 손실이 커지는가`를 보는 데 있습니다. 회귀에서는 목표값과의 거리, 분류에서는 정답 클래스에 준 확률이 핵심 축입니다.
