...
![문제 유형별 손실 읽기 축](../../../assets/part-05/chapter-04/problem-loss-axes-ko.svg)

따라서 손실 숫자끼리 바로 크기만 비교하기보다, 먼저 같은 문제 유형 안에서 어느 예측이 더 나쁜지를 읽어야 합니다. 문제 유형이 바뀌면 손실이 읽는 축도 함께 바뀝니다.
