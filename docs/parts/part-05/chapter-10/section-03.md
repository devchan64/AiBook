...
P5-10.2까지 오면 지시 튜닝과 정렬 문제를 보게 됩니다. 그러면 실무 관점에서는 다음 질문이 바로 따라옵니다.
...
- 입력 설계 자체를 다루는 문제는 P5-11 프롬프트 엔지니어링으로 이어집니다.
- 외부 근거 연결은 P5-12 RAG와 P5-13 벡터 검색으로 이어집니다.
- 실행과 호출은 P5-14 도구 사용과 P5-15 에이전트 구조로 이어집니다.

가까운 다음 본류는 P5-11.1 프롬프트 엔지니어링(prompt engineering)입니다.
