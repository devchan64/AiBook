...
용어가 다시 흩어져 보일 때는 개념사전의 [쿼리-키-값(query-key-value, QKV)](../../../reference/concept-glossary-parts/07-siot.md#self-attention)과 [멀티헤드 어텐션(multi-head attention)](../../../reference/concept-glossary-parts/07-siot.md#self-attention) 항목을 함께 다시 봅니다.
...
## QKV와 multi-head attention: 확인할 판단 기준

이 사례 절은 다음 질문으로 중심축을 확인한다.

- 오픈체크리스트의 중심축 문장인 "query, key, value와 multi-head attention을 처음 읽는 최소 기준을 보충해야 합니다."를 본문 사례에서 어느 대목으로 확인할 수 있는가?
