...
P5-13.1과 P5-13.2에서는 attention과 self-attention의 직관을 먼저 잡았습니다. 그런데 여기까지 읽으면 자연스럽게 다음 질문이 생깁니다.
...
| --- | --- | --- |
| attention / self-attention 직관 | 필요한 위치를 어떻게 다시 찾아 참고하는가? | P5-13.1, P5-13.2 |
| QKV / multi-head 이름 | 그 참조 계산을 왜 query, key, value와 여러 head로 설명하는가? | P5-13.3 |
| Transformer 블록 연결 | 이 이름들이 실제 블록 구조 안에서 어떤 핵심 부품으로 반복되는가? | P5-14.1 |
