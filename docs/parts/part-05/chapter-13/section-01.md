...
| --- | --- | --- |
| function calling | 한 번의 실행 요청을 어떤 payload로 넘길 것인가? | P5-12.2 |
| agent 목표 흐름 | 여러 호출과 읽기를 어떤 순서로 이어 갈 것인가? | P5-13.1, P5-13.2 |
| MCP / harness 관리 | 그 흐름을 어떤 연결 규칙과 기록 환경 안에서 관리할 것인가? | P5-14 |

즉, 이 절에서 가장 짧게 붙잡아야 할 닫힘 구조는 `function calling -> agent 목표 흐름 -> MCP/harness 관리`입니다. 여기서는 그 가운데 단계인 `목표 흐름`을 맡고 있고, 바로 뒤 장에서 이 흐름이 계획-행동-관찰 루프로 구체화되며, 다음 장에서 연결 규칙과 실행 기록으로 넘어갑니다.
