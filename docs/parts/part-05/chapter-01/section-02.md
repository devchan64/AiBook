...
선형 결합과 활성화의 기본 뜻이 뒤 절에서 다시 흐려지면 개념사전의 [선형 결합(linear combination)](../../../reference/concept-glossary-parts/01-giyeok.md#weighted-sum), [가중합(weighted sum)](../../../reference/concept-glossary-parts/01-giyeok.md#weighted-sum), [활성화 함수(activation function)](../../../reference/concept-glossary-parts/14-hieut.md#activation-function) 항목을 먼저 다시 봅니다.
...
- 퍼셉트론이 [판단 경계(decision boundary)](../../../reference/concept-glossary-parts/01-giyeok.md#decision-boundary)를 만든다는 말은 무엇인가?
...
## 선형 결합과 활성화: 확인할 판단 기준

이 사례 절은 다음 질문으로 중심축을 확인한다.

- 오픈체크리스트의 중심축 문장인 "선형 결합과 활성화가 왜 함께 있어야 하는지 보여 주어야 합니다."를 본문 사례에서 어느 대목으로 확인할 수 있는가?
