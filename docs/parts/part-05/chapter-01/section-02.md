...
선형 결합과 활성화의 기본 뜻이 뒤 절에서 다시 흐려지면 개념사전의 [선형 결합(linear combination)](../../../reference/concept-glossary-parts/07-siot.md#linear-combination), [가중합(weighted sum)](../../../reference/concept-glossary-parts/01-giyeok.md#weighted-sum), [활성화 함수(activation function)](../../../reference/concept-glossary-parts/14-hieut.md#activation-function) 항목을 먼저 다시 봅니다.
