...
이번 예제의 목표는 `같은 뜻의 문장도 토크나이저 규칙이 다르면 토큰 수가 달라질 수 있다`는 점을 눈으로 확인하는 것입니다. 실제 서비스용 토크나이저 전체를 구현하지는 않지만, `긴 조각부터 찾는 longest-match` 방식으로도 토큰화 차이의 핵심은 충분히 볼 수 있습니다.
...
for text in examples:
    ...
    print(text)
    print("A pieces =", pieces_a, "count =", len(pieces_a))
    print("B pieces =", pieces_b, "count =", len(pieces_b))
    print("---")
```
...
```text
회의는 내일 오전10시에 시작합니다.
A pieces = ['회의', '는', '내일', '오전10시', '에', '시작', '합니다', '.'] count = 8
B pieces = ['회의', '는', '내일', '오전', '10', '시', '에', '시작', '합니다', '.'] count = 10
---
회의는 내일 오전 10시에 시작합니다.
A pieces = ['회의', '는', '내일', '오', '전', '10', '시', '에', '시작', '합니다', '.'] count = 11
B pieces = ['회의', '는', '내일', '오전', '10', '시', '에', '시작', '합니다', '.'] count = 10
---
회의는 내일 10:00 AM에 시작합니다.
A pieces = ['회의', '는', '내일', '10:00', 'AM', '에', '시작', '합니다', '.'] count = 9
B pieces = ['회의', '는', '내일', '10:00', 'AM', '에', '시작', '합니다', '.'] count = 9
---
```
