...
퍼셉트론 용어를 뒤 절에서 다시 짧게 확인해야 할 때는 개념사전의 [퍼셉트론(perceptron)](../../../reference/concept-glossary-parts/03-digeut.md#multilayer-neural-network) 항목을 기준선으로 돌아옵니다.
...
- 오픈체크리스트의 중심축 문장인 "퍼셉트론을 입력, 가중치, 합산, 경계 판단의 최소 계산 구조로 설명해야 합니다."를 본문 사례에서 어느 대목으로 확인할 수 있는가?
