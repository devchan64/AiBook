...
If the term perceptron needs to be checked again briefly in later sections, return to the [perceptron](../../../reference/concept-glossary.md#perceptron) entry in the concept glossary as the baseline.
