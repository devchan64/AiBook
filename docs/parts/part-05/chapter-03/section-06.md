...
출력 해석과 활성화 선택의 기준이 다시 흐려지면 개념사전의 [모델 출력 정의(model output)](../../../reference/concept-glossary-parts/05-mieum.md#model-output), [출력층(output layer)](../../../reference/concept-glossary-parts/05-mieum.md#model-output), [활성화 함수(activation function)](../../../reference/concept-glossary-parts/14-hieut.md#activation-function), [소프트맥스(softmax)](../../../reference/concept-glossary-parts/07-siot.md#softmax) 항목을 함께 다시 봅니다.
...
## 출력층과 활성화의 선택: 확인할 판단 기준

이 사례 절은 다음 질문으로 중심축을 확인한다.

- 오픈체크리스트의 중심축 문장인 "출력층 활성화 선택이 문제 유형과 연결된다는 점을 닫아야 합니다."를 본문 사례에서 어느 대목으로 확인할 수 있는가?
