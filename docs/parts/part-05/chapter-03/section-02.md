...
이 절의 목적은 `모든 AI 발전을 LLM 역사로 한 줄에 늘어놓는 오해`를 줄이는 데 있습니다.
...
이 절은 역사 설명을 더 보수적으로 정리하기 위한 절입니다. 초심자는 모든 딥러닝 성과를 하나의 직선 위에 놓기 쉽고, 재학습자는 과거에 본 다양한 키워드를 한 줄 역사로 묶고 싶어질 수 있습니다.
