...
If the relationship among learning rate, gradient, and update starts to blur again, it helps to return together to the [learning rate](/AiBook/en/reference/concept-glossary-alpha/h/#hyperparameter) and [optimizer](/AiBook/en/reference/concept-glossary-alpha/o/#optimizer) entries in the concept glossary.
