...
![단순 직접 업데이트와 Adam-like 비교에 쓰는 gradient 입력 흐름](../../../assets/part-05/chapter-07/direct-adam-gradient-history-ko.png)
...
![단순 직접 업데이트와 Adam-like의 step별 delta 비교](../../../assets/part-05/chapter-07/direct-adam-delta-comparison-ko.png)
...
![단순 직접 업데이트와 Adam-like의 risk_weight 이동 경로](../../../assets/part-05/chapter-07/direct-adam-risk-weight-trajectory-ko.png)
