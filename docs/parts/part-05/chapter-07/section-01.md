...
초심자는 여기서 먼저 다음 세 질문으로 읽으면 좋습니다.
...
초심자 기준에서는 다음 한 줄 비교로 먼저 잡아도 충분합니다.
...
이 예제에서 초심자가 읽어야 할 핵심은 숫자의 크기 자체보다 `두 단계의 역할 차이`입니다.
...
초심자 관점에서는 이 역사 설명을 다음처럼 읽으면 됩니다.
