...
If the distinction between learning and model execution starts to blur again in later sections, it helps to return together to the [training](/AiBook/reference/concept-glossary-parts/14-hieut/#training) and [inference](/AiBook/reference/concept-glossary-parts/11-chieut/#inference) entries in the concept glossary.
