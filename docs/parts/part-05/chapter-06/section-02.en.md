...
If this distinction among the three units starts to blur again, return to the [training](/AiBook/en/reference/concept-glossary-alpha/m/#model-training) entry in the concept glossary and reread batch, step, and epoch as different units for dividing a training repetition.
