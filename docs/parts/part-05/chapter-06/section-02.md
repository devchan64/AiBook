...
이 세 단위의 구분이 다시 흐려지면 개념사전의 [배치(batch)](../../../reference/concept-glossary-parts/06-bieup.md#batch), [학습(training)](../../../reference/concept-glossary-parts/14-hieut.md#training), [에폭(epoch)](../../../reference/concept-glossary-parts/08-ieung.md#epoch) 항목을 함께 다시 보는 편이 좋습니다.
