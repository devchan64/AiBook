...
처음 읽을 때는 이 보충학습을 `좋은 표현 공간`과 `빠른 후보 탐색`을 분리해 보는 손잡이로만 잡고, 구현 세부는 뒤의 검색 절과 본편 바깥으로 넘겨 두는 편이 가장 안전합니다.

| 지금 단계의 손잡이 | 바로 다음에 이어질 질문 | 뒤에서 본격적으로 다시 읽는 위치 |
| --- | --- | --- |
| 임베딩 학습 | 어떤 문장과 문서를 더 가깝게 놓는 표현 공간을 만들 것인가? | P5-2.3, P5-5.1, P5-6.1 |
| ANN 검색 | 그 표현 공간 안에서 가까운 후보를 어떻게 더 빨리 좁힐 것인가? | P5-2.3, P5-11.1, P5-11.2 |
| 검색 시스템 연결 | 이 두 층을 실제 저장소와 인덱스 구조에 어떻게 붙일 것인가? | P5-11.1, P5-11.2 |
