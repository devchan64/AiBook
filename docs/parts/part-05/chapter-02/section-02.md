...
표현 학습(representation learning)이라는 더 큰 흐름은 P5-10.1, P5-10.2에서 다시 확장합니다. CNN에서의 필터와 공간 표현은 P5-11.1, P5-11.2에서, attention 기반 표현은 P5-13.1, P5-13.2와 P5-14.1, P5-14.2에서 다시 연결합니다. 즉, 이번 절은 은닉층을 `입력을 다시 적는 내부 표현 층`으로 먼저 붙잡는 데 집중합니다.
