...
은닉층이 실제로 어떤 표현을 만든다고 읽을 수 있는지는 P5-2.2에서 더 이어서 다루고, 활성화 함수 비교는 P5-3.1부터 P5-3.5까지 다시 연결합니다. 역전파(backpropagation)의 계산 공식은 P5-5.1, P5-5.2에서 다시 봅니다. 보편 근사 정리와 깊이·너비의 이론 비교는 이 책의 현재 본편 범위 밖에 둡니다.
...
![은닉층 두 노드가 함께 켜지는 입력 영역과 후속 실험 이동](/AiBook/assets/part-05/chapter-02/hidden-pattern-regions-ko.png)
