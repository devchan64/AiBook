...
프롬프트만으로 부족한 최신성·근거 문제는 바로 다음 P5-12.1 RAG의 필요성과 P5-12.2 검색 결과와 생성의 결합에서 다시 회수합니다. 평가 구조는 P5-17.1과 P5-17.2에서, 에이전트 프레임워크의 큰 그림은 P5-15.1과 P5-15.2에서 각각 다시 다룹니다.
