...
P5-11.1과 P5-11.2에서는 CNN이 왜 이미지와 잘 맞는지, 그리고 convolution과 pooling이 어떤 역할을 하는지를 먼저 보았습니다. 여기서 자연스럽게 다음 질문이 생깁니다.
...
- 이후 P5-13.2 self-attention, P5-14 Transformer와 왜 연결되는지 말할 수 있는가?
