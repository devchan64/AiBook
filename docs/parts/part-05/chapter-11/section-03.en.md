...
When you need to briefly confirm again the different starting unit of a Vision Transformer, return to the glossary entry on [ViT (Vision Transformer)](/AiBook/en/reference/concept-glossary-alpha/t/#transformer).
