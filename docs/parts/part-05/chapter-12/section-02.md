...
검색 저장소와 인덱스 문제는 다음의 P5-13.1 벡터 데이터베이스와 P5-13.2 인덱스와 검색 품질에서 다시 회수합니다. context window 제약 자체는 앞의 P5-4.2 attention과 context window에서 이미 다루었고, 운영상 제약은 P5-18.1에서 다시 연결합니다.
