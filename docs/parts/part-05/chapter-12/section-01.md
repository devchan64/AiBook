...
P5-11.2에서는 프롬프트만으로는 최신성, 근거 보장, 실행 가능성 같은 문제를 해결하기 어렵다는 점을 보았습니다. 그러면 이제 다음 질문이 자연스럽게 나옵니다.
...
- 임베딩, 벡터 검색, 도구 사용이 왜 뒤에서 다시 등장하는지 연결하며
