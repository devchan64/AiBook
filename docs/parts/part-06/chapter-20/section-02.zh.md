...
以后阅读 P6-13.1 向量数据库和 P6-13.2 索引与搜索质量，看到搜索流水线内部如何拆分结构时，也可以重新恢复这个比较标准。
...
一旦固定这句话，就不需要背下每个细节任务名称，也能阅读 P6-5.1、P6-7.1 中的 GPT 和 next-token prediction 说明，或 P6-12.1、P6-12.2 中的 RAG 说明。
