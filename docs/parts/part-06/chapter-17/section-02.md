# P6-18.2 오류를 복구 경로로 나누는 운영 중 실패 대응
...
P6-17.2의 자동 평가와 사람 평가, P6-18.1의 운영 제약, 지금 절의 실패 대응을 실제 운영 순서로 다시 묶으면 다음 네 줄이 먼저 보여야 합니다.
...
- 바로 앞의 P6-18.1 서비스 운영 제약을 `무엇을 조심해야 하는가`에서 `실패가 났을 때 어디를 추적해야 하는가`로 더 구체화하고
