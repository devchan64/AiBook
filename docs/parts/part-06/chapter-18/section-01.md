...
여기서는 세부 구조를 모두 외우기보다, Part 6 본류를 읽은 뒤 그 흐름을 다시 정리할 수 있게 해 주는 최소한의 `역사 지도`를 만드는 데 집중합니다. 토큰, Transformer, GPT, 사전학습을 이미 읽은 뒤 그 구조가 어떤 역사적 전환을 거쳐 왔는지 배경 축으로 다시 묶는 정도면 충분합니다.
