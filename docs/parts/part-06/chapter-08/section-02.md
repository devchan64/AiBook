...
대신 정렬 문제가 실제 사용 층에서 어떻게 이어지는지는 P6-9.1 프롬프트 엔지니어링, P6-9.2 프롬프트의 한계, P6-15.1 LLM 평가, P6-15.2 자동 평가와 사람 평가, P6-16.1 서비스 운영 제약, P6-16.2 운영 중 실패 대응에서 다시 회수합니다. RLHF나 constitutional AI의 세부 설계 전부는 현재 본편 범위 밖으로 둡니다.
