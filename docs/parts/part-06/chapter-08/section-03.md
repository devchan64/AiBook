...
프롬프트 조정은 P6-9.1, P6-9.2에서, 근거 연결은 P6-10.1, P6-10.2와 P6-11.1, P6-11.2에서, 실행 연결은 P6-12.1, P6-12.2와 P6-13.1, P6-13.2에서 다시 구체화합니다. 파인튜닝 축 안의 세부 이름 구분은 바로 다음 P6-8.4에서 다시 보강합니다. 운영 판단의 큰 축은 P6-15.1, P6-15.2와 P6-16.1, P6-16.2에서 다시 회수합니다. 이 절은 후속 장의 세부 기술을 대신 설명하기보다 `무엇을 어디서 먼저 손봐야 하는가`를 구분하는 선택 지도로 읽는 편이 좋습니다.
