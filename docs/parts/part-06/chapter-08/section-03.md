...
- 입력 설계 자체를 다루는 문제는 P6-9 프롬프트 엔지니어링으로 이어집니다.
- 외부 근거 연결은 P6-10 RAG와 P6-11 벡터 검색으로 이어집니다.
- 실행과 호출은 P6-12 도구 사용과 P6-13 에이전트 구조로 이어집니다.

가까운 다음 본류는 P6-9.1 프롬프트 엔지니어링(prompt engineering)입니다.

즉, 이 절은 뒤 장을 대신하는 절이 아니라, 뒤 장을 어떤 질문으로 읽어야 하는지 정리하는 지도입니다.

## 언제 선택 지도 관점을 먼저 떠올려야 하는가
