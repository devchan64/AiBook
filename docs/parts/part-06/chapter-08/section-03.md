...
개별 모델의 비용 비교표와 파인튜닝 파이프라인 전체는 여기서 다루지 않고, 각각의 선택 기준만 남깁니다. 대신 프롬프트 조정은 P6-9.1, P6-9.2에서, 근거 연결은 P6-10.1, P6-10.2와 P6-11.1, P6-11.2에서, 실행 연결은 P6-12.1, P6-12.2와 P6-13.1, P6-13.2에서 다시 구체화합니다. 조직별 품질 운영 프로세스의 세부 설계는 현재 본편 범위 밖으로 두고, 운영 판단의 큰 축은 P6-15.1, P6-15.2와 P6-16.1, P6-16.2에서 다시 회수합니다.

이 절에서는 후속 장의 세부 기술을 대신 설명하기보다, `무엇을 어디서 먼저 손봐야 하는가`를 구분하는 판단 기준을 줍니다.

이 절은 `선택 지도 축`으로 읽으면 충분합니다.
