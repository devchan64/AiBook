...
즉, 이 장은 `BERT를 새 본편처럼 먼저 끝내는 장`이 아니라 `GPT 본류를 더 정확히 읽기 위해 뒤에서 다시 꺼내 보는 비교 장`으로 두는 편이 현재 Part 6 흐름에 더 맞습니다.
...
| --- | --- | --- |
| GPT와 BERT 차이가 `생성/이해` 한 줄로만 남아 있다 | 보통 아니다 | P6-4.1, P6-5.1, P6-11.1 |
