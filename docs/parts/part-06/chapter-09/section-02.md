# P6-10.2 잘 따르는 답과 허용 가능한 답을 나누는 정렬

> Section ID: `P6-10.2`
> Version: `v2026.07.31`

P6-10.1에서는 지시 튜닝(instruction tuning)이 모델을 더 `대화형 조수 같은 반응`으로 만드는 조정 단계라는 점을 보았습니다. 하지만 말을 잘 따르는 답이 곧바로 안전하고 바람직한 답이라는 보장은 없습니다.
...
- 이후 P6-17.1 LLM 평가, P6-17.2 자동 평가와 사람 평가, P6-18.1 서비스 운영 제약, P6-18.2 운영 중 실패 대응을 읽는 기준을 만들어 주기 때문입니다
...
## 잘 따르는 답과 허용 가능한 답을 나누는 정렬: 확인할 판단 기준

이 사례에서는 정렬을 유용성, 안전성, 사실성, 거절 기준을 함께 맞추는 문제로 설명하는지 확인한다.
...
- P6-10.3을 기술 이름보다 `어떤 부족을 먼저 고칠 것인가`의 선택 문제로 읽을 준비가 되었는가?
