...
在本节，我们先完成从`应该读什么`到`实际应该查询、计算或执行什么`的移动。如何把这个执行请求稳定成名称和参数结构，会接到 P6-13.2 的 function calling；如何串联多个执行，会接到 P6-14 的 AI agent 结构。
...
- P6-14.1 和 P6-14.2 AI agent：如何随时间连接多个工具调用
