...
초심자 기준에서는 용어 정의를 외우기보다, 관찰 결과가 실제로 다음 분기를 어떻게 바꾸는지 먼저 붙잡는 편이 더 안전합니다.
...
계획-행동-관찰 루프를 처음 읽을 때 초심자가 가장 자주 놓치는 것은 `루프가 돈다`는 말만 기억하고, 실제로 무엇이 `계속 진행`, `종료`, `사람 검토 전환`을 가르는지까지는 바로 연결하지 못하는 점입니다. 하지만 실무에서는 바로 그 분기 기준이 있어야 무한 반복과 성급한 종료를 함께 피할 수 있습니다.
