...
사례를 읽기 전에 이 도식을 아래처럼 한 번만 훑으면 호흡이 더 짧아집니다.

| 공통 질문 | 도식에서 먼저 볼 것 |
| --- | --- |
| 무엇을 먼저 후보로 올리는가 | 질문, 문단, 추천 항목 중 비교 대상을 봅니다. |
| 후보가 왜 바로 정답이 아닌가 | 검토 단계가 따로 남아 있는지 봅니다. |
| 뒤에서 무엇이 추가되는가 | 최신성, 근거 확인, 사용자 맥락 같은 후속 판단을 봅니다. |
