...
- 오픈체크리스트의 중심축 문장인 "벡터 데이터베이스가 검색 결과로 원문과 메타데이터 payload를 함께 돌려준다는 점을 실행 감각으로 보여 주어야 합니다."를 본문 사례에서 어느 대목으로 확인할 수 있는가?
...
- P6-13.1 도구 사용, P6-14.1 AI 에이전트 구조: 검색 기반 기능이 전체 시스템 안에서 어디에 놓이는지 보는 기준
