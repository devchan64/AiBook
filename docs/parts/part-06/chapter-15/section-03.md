# P6-16.3 보충학습: 에이전트 워크플로와 이미지 생성 워크플로는 무엇이 다른가

> Section ID: `P6-16.3`
> Version: `v2026.08.03`

P6-16.1에서는 도구와 자원을 공통 형식으로 연결하는 관점을, P6-16.2에서는 실행을 기록하고 다시 설명하는 하네스 관점을 보았습니다. 이 보충 절은 그 둘을 다른 생성형 AI 장면에서도 다시 읽어 보기 위한 비교 지도입니다.
