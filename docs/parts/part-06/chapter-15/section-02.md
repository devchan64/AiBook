...
이 절은 Part 6에서 자동 평가(automatic evaluation)와 사람 평가(human evaluation)를 대표로 설명하는 Section입니다. 평가 축 자체는 P6-15.1에서 세우고, 여기서는 그 축을 누구에게 어떤 비중으로 맡길지 분업 기준으로 다시 묶습니다.
