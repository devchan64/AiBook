...
judge model 설계와 통계적 샘플링 전략의 세부는 여기서 다루지 않습니다. 대신 운영 안에서 어떤 실패를 다시 추적해야 하는지는 P6-16.1과 P6-16.2에서 다시 회수합니다. 조직별 QA 프로세스 전체와 세부 운영은 현재 본편 범위 밖으로 둡니다.
...
이 질문은 P6-16.1 서비스 운영 제약으로 이어집니다.
