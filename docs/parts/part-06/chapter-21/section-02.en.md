...
| --- | --- |
| P7-5.1–P7-5.3, P7-5.4, and P7-5.11 image experiments | Read sequential CPU offload as a device for execution feasibility, and record model file, dtype, reference input, resolution, and human-review ledger together |
