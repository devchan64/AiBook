...
| 검색과 RAG | 가까운 후보를 실제 문서 검색과 생성 결합에 어떻게 쓸 것인가? | P6-12.1, P6-12.2, P6-13.1, P6-13.2 |
...
## 정답이 아니라 후보를 만드는 가까운 벡터: 확인할 판단 기준

이 사례에서는 가까운 벡터가 최종 정답이 아니라 후보를 좁히는 신호라는 점을 사례와 함께 보여 주는지 확인한다.
