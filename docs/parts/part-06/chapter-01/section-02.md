...
따라서 여기서 남길 구분은 다음입니다.

| 오해 | 다시 잡을 기준 |
| --- | --- |
| LLM은 생성형 AI 전체다. | LLM은 생성형 AI를 깊게 읽기 위한 대표 사례다. |
| 생성형 AI는 산출물을 만들기만 하면 된다. | 산출물은 사용 장면에서 검토, 보강, 기록되어야 한다. |
| 텍스트 생성은 단순 글쓰기 기능이다. | 텍스트 생성은 검색, 도구, 평가, 운영 구조와 쉽게 연결된다. |
