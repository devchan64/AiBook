...
초심자에게는 다음 세 문장을 함께 붙이는 편이 더 안전합니다.
...
여기서 초심자가 특히 구분해야 하는 것은 두 흐름의 질문이 다르다는 점입니다.
...
이 구분은 초심자에게 매우 중요합니다. 많은 독자가 `역전파가 곧 업데이트`라고 오해하지만, 실제 업데이트는 아직 일어나지 않았습니다. 역전파는 `바꿔야 할 방향과 민감도`를 계산할 뿐입니다.
