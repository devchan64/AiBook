...
얼굴 사진을 분류할 때도 모델이 처음부터 `이 사람 누구인가`를 한 번에 아는 것은 아닙니다. 사람도 사진을 볼 때 얼굴 전체 인상만으로 먼저 판단하려 들 수 있지만, 실제로는 눈썹 경계, 눈 주변 그림자, 코선, 입 모양 같은 부분 단서를 보고 전체 인상으로 묶어 갑니다. 조명 각도나 배경 색이 달라지면 전체 분위기는 꽤 달라 보여도, 눈과 코 사이 거리나 입 주변 곡선처럼 더 안정적인 단서는 그대로 남는 경우가 많습니다. CNN도 이런 작은 지역 단서가 먼저 잡히고, 그 단서들이 쌓이면서 더 큰 얼굴 표현으로 이어질 수 있습니다. 그래서 이 장면에서 확인 가능한 결과는 조명이나 배경이 조금 달라져도 눈, 코, 입 주변 구조가 유지되면 같은 얼굴 후보로 더 안정적으로 묶인다는 점입니다.
