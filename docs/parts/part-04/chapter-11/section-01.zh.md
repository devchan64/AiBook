...
![展示线性分数 z 经过 sigmoid 后变成 0 到 1 之间可像概率那样读取的值的图](/AiBook/assets/part-04/chapter-11/p4-11-1-sigmoid-score-map-zh.png)
...
![展示同样概率分数在 threshold 0.5 与 0.7 下会被读成不同行为的比较图](/AiBook/assets/part-04/chapter-11/p4-11-2-threshold-shift-zh.png)
