...
padding, stride, dilation의 상세 공식은 여기서 전개하지 않습니다. 대신 지역 패턴에서 계층적 표현으로 이어지는 큰 그림은 P4-10.2와 P4-11.1에서 다시 회수합니다. 다양한 pooling 변형, 최신 vision 구조, FFT convolution 같은 고급 구현은 이 책의 현재 본편 범위 밖에 둡니다.
