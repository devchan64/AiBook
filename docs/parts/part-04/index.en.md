...
- What do [input](/AiBook/en/reference/concept-glossary-alpha/i/#input), [output](/AiBook/en/reference/concept-glossary-alpha/o/#output), [label](/AiBook/en/reference/concept-glossary-alpha/l/#label), and [reward](/AiBook/en/reference/concept-glossary-alpha/r/#reward) each mean, and where are they separated?
