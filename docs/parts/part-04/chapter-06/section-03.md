...
## SRE metric으로 머신러닝 metric을 덜 낯설게 읽기
...
## 사이트 신뢰성 엔지니어링에서 지표를 읽는 법: 확인할 판단 기준

이 사례 절은 다음 질문으로 중심축을 확인한다.

- 오픈체크리스트의 중심축 문장인 "실무 운영 지표를 읽는 법이 모델 평가와 어떻게 닿고 다른지 보충해야 합니다."를 본문 사례에서 어느 대목으로 확인할 수 있는가?
...
## 사이트 신뢰성 엔지니어링에서 지표를 읽는 법: 추가 확인 장면 1
