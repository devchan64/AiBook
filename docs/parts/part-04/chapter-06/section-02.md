...
## 문제 유형별 평가 기준: 확인할 판단 기준

이 사례 절은 다음 질문으로 중심축을 확인한다.

- 오픈체크리스트의 중심축 문장인 "문제 유형에 따라 어떤 평가 기준이 달라지는지 정리해야 합니다."를 본문 사례에서 어느 대목으로 확인할 수 있는가?
...
```python
# 분류, 회귀, 군집화 문제에서 각각 다른 평가 기준을 계산하고 비교하는 예제입니다.
