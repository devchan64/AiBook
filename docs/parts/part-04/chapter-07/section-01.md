...
초심자에게는 다음 세 문장을 먼저 붙잡게 하는 편이 좋습니다.
...
이 세 문장이 Part 4의 학습 계산 흐름을 읽는 가장 작은 지도입니다. 초심자는 세 용어를 따로 외우기보다, `틀림 -> 책임 -> 실제 수정`의 순서로 묶어 기억하는 편이 훨씬 안전합니다.
