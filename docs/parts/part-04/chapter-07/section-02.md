...
- SGD는 기본적인 gradient-based update가 가장 단순한 형태에서 어떻게 움직이는지 읽게 해 주는 기준점이고, Adam은 누적 정보와 좌표별 조절을 더 반영하는 적응형 optimizer입니다.
- Adam이 실무에서 자주 쓰여도 SGD는 여전히 중요한 기준점이며, optimizer 비교는 속도, 안정성, 일반화까지 함께 보아야 합니다.
