...
## 휴리스틱(heuristic)이 필요한 이유에서 남길 판단 기준
...
## 휴리스틱이 필요한 이유: 확인할 판단 기준

이 사례 절은 다음 질문으로 중심축을 확인한다.

- 오픈체크리스트의 중심축 문장인 "휴리스틱이 후보를 줄이는 검증 가능한 작업 가설이며, 계산 한계와 불확실성 속에서 충분히 좋은 출발점을 잡는 규칙이라는 점을 보여 주어야 합니다."를 본문 사례에서 어느 대목으로 확인할 수 있는가?
...
- 휴리스틱이 제한된 시간과 정보 안에서 후보를 줄이는 실용적 판단 기준이라는 점을 설명할 수 있는가
- 휴리스틱이 알고리즘을 대체하는 것이 아니라, 알고리즘을 적용할 후보와 순서를 정하는 데 쓰인다는 점을 설명할 수 있는가
- 휴리스틱을 개인 감각이 아니라 검증 가능한 작업 가설로 다뤄야 하는 이유를 설명할 수 있는가
