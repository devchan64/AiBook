...
이 절은 입문적으로 `클러스터링이 어떤 질문에 답하는가`를 이해하는 데 집중합니다. 결과 해석의 주의점은 P4-17.2에서 이어서 다루고, silhouette score 같은 군집 품질 지표는 P4-6.4 보충학습에서 다시 회수합니다. 차원 축소와 함께 군집 구조를 읽을 때의 주의점은 P4-18.1, P4-18.2에서 다시 연결합니다. 계층적 군집화와 스펙트럴 클러스터링의 구현은 이 책의 현재 본편 범위 밖에 둡니다.
...
이때도 군집 결과를 바로 결론으로 쓰지 말고, 어떤 묶음 가설과 어떤 대표 사례를 먼저 남길지 같이 적어 둡니다. 특히 군집이 그럴듯해 보여도 그것은 먼저 검토 필요 신호와 해석 후보를 정리하는 단계이지, 원인 설명이나 정책 확정 단계는 아닙니다.

| 같이 남길 항목 | 이번 절에서 적는 내용 | 왜 필요한가 |
| --- | --- | --- |
| 묶음 가설 | 어떤 특징 기준에서 몇 개의 묶음이 보이는가 | 군집을 무엇으로 읽었는지 분명히 하기 위해 |
