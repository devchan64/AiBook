...
커리큘럼 관점에서도 이 절은 RNN 장의 핵심 마무리입니다. 단순히 구조 이름을 외우는 대신, `무엇이 문제였기 때문에 다음 구조가 나왔는가`를 보여 주어야 바로 뒤의 P4-13 attention, P4-14 Transformer, 그리고 Part 5의 P5-4 LLM 구조 설명이 매끄럽습니다.
