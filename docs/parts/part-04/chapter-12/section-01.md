...
초심자 기준에서는 세부 수식보다 다음 정도로 이해하면 충분합니다.
...
문장에서 마지막 단어를 읽을 때도, 첫 단어와 중간 문맥이 중요할 수 있습니다. 예를 들어 부정 표현은 문장 끝까지 의미를 바꿀 수 있습니다. 순차 상태를 이어가는 구조가 필요해지는 이유입니다.

### 사례 2. 음성 인식

한 순간의 파형만 보고는 음소를 정확히 읽기 어려울 수 있습니다. 앞뒤 시간 맥락을 함께 보는 구조가 더 자연스럽습니다.

### 사례 3. 시계열 예측

현재 센서 값이 직전 몇 초, 몇 분, 몇 시간의 흐름과 연결될 수 있다면, 과거 상태를 이어받는 구조가 유리할 수 있습니다.
