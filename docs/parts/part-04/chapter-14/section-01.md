...
각 단어가 문장 전체를 참조하며 문맥을 읽고, 그 결과를 다시 각 위치 표현에 반영할 수 있습니다. 이는 긴 문장 번역에서 중요한 전환이었습니다.

### 사례 2. 문서 요약

문서 전체에서 관련 위치를 고르게 참고하고, 그 관계를 반복 블록 안에서 계속 정제할 수 있습니다.

### 사례 3. 코드 생성과 LLM

코드나 자연어 생성에서는 멀리 떨어진 토큰 간 관계가 중요합니다. Transformer 블록은 이런 문맥 정보를 반복적으로 갱신하는 기본 장치가 됩니다.
