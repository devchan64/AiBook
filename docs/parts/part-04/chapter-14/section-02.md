...
코드에서는 먼 앞쪽의 함수 정의나 변수 선언이 뒤쪽 토큰 해석에 영향을 줄 수 있습니다. 사람은 바로 앞 몇 줄만 보면 충분하다고 느끼기 쉽지만, 실제로는 아래 줄을 읽다가 위에서 선언한 이름과 타입을 다시 확인해야 하는 경우가 많습니다. 긴 문맥 처리 능력은 여기서도 중요합니다.
