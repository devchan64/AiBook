...
- 단순히 class를 나누는 것보다 경계의 여유와 안정성이 더 중요해 보일 때, margin 관점을 먼저 꺼냅니다.
- 몇 개의 경계 근처 사례가 전체 판단을 좌우하는 장면을 볼 때, support vector가 왜 핵심인지 다시 떠올립니다.
- 로지스틱 회귀나 k-NN과 비교해 SVM의 질문이 무엇인지 정리해야 할 때, `무엇이 더 좋은 경계인가`라는 기준으로 다시 읽습니다.
