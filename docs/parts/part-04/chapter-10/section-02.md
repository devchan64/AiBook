...
회귀 지표는 한 번에 나열하기보다, 지금 어떤 실패를 더 경계하는지에 따라 읽는 순서를 분명히 해야 합니다.
...
이 표의 목적은 지표를 하나 고정하는 것이 아니라, `지금 어떤 종류의 실패를 읽으려 하는가`에 따라 평가 순서를 분명히 하는 데 있습니다.
...
평가와 한계를 본 뒤에는, 선형회귀가 왜 이런 방식으로 오차를 읽는지 역사적 배경도 더 분명하게 이해할 수 있습니다. 선형회귀의 배경에는 두 개의 흐름이 함께 있습니다.
