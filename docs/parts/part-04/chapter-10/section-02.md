...
회귀 진단의 기초 읽기, 유의성 검정, 다중공선성의 해석은 P4-10.3 보충학습에서 다시 정리하고, 정규화와 관련 하이퍼파라미터의 더 넓은 관점은 P4-9.1, P4-9.2에서 다시 연결합니다. feature engineering의 큰 흐름은 P4-7.1, P4-7.2와 P4-18.1, P4-18.2에서 다시 연결됩니다.
