...
- 내부 표현을 배운다는 말은 초심자에게 어떻게 설명할 수 있는가?
...
표현(representation)은 초심자에게 추상적으로 들리기 쉽습니다. 이 책에서는 먼저 다음처럼 이해하면 충분합니다.
...
물론 모델이 실제로 그런 이름을 붙이는 것은 아닙니다. 하지만 초심자에게는 `원본보다 계산하기 쉬운 중간 표현을 만든다`는 감각이 중요합니다.
...
- 표현 학습을 초심자 수준에서 한 문장으로 설명할 수 있는가?
