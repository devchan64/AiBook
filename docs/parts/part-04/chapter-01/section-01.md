...
이 내용은 P4-1.2와 P4-2장으로 이어서 다룹니다.
...
이 관점은 더 앞선 McCulloch와 Pitts의 1943년 인공 뉴런(artificial neuron) 모형과도 이어집니다. 초심자 기준에서는 다음 정도로만 기억하면 충분합니다.
...
초심자는 가중치만 이해하고 편향(bias)을 빼먹기 쉽습니다. 하지만 편향은 중요한 기준 조정값입니다.
...
이 예시는 매우 단순하지만, 퍼셉트론의 핵심 구조를 그대로 보여 줍니다.
