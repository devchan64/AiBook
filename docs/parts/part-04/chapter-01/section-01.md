...
여기서는 용어를 모두 외우기보다, “AI라는 큰 분야 안에서 머신러닝이 어떤 위치에 있는가”와 “왜 바로 LLM이나 딥러닝으로 가지 않고 데이터, 모델, 학습, 평가를 먼저 보는가”를 먼저 확인합니다.
...
이 절의 용어는 한 번에 모두 이해하려고 하면 어렵습니다. 다음 순서로 읽으면 포함 관계와 역할이 더 분명해집니다.
...
용어가 많아지면 포함 관계보다 각 말이 답하려는 질문을 먼저 보는 편이 더 분명합니다.
...
이 표는 용어 사전처럼 외우기보다 하나의 질문 묶음으로 읽는 편이 낫습니다. “무엇을 풀려는가”, “무엇을 입력으로 주는가”, “무엇을 맞추려 하는가”, “맞았는지 어떻게 확인하는가”가 머신러닝 문서를 읽을 때 가장 먼저 확인할 질문입니다.
...
- Part 4에서 데이터, 학습, 평가를 먼저 봐야 한다고 설명할 수 있는가?
