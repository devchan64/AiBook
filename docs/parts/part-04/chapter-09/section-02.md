...
## 튜닝은 하이퍼파라미터 후보를 검증 점수로 고르는 일이다
...
- 오픈체크리스트의 중심축 문장인 "튜닝 비용과 검증 절차를 함께 봐야 한다는 점을 보여 주어야 합니다."를 본문 사례에서 어느 대목으로 확인할 수 있는가?
...
- grid search와 random search를 모두 `후보 비교 방식`으로 이해할 수 있는가
