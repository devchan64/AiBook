...
이 차이가 잡히면 뒤의 튜닝 절도 훨씬 자연스럽게 읽힙니다.
...
모든 알고리즘의 설정을 외우기보다, 어떤 종류의 설정이 반복되는지부터 보는 편이 낫습니다.
...
즉, 독자가 지금 이 절에서 가져가야 할 감각은 다음입니다.
