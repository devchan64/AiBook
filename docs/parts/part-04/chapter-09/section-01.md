...
- 오픈체크리스트의 중심축 문장인 "하이퍼파라미터가 학습 규칙과 구조를 바꾸는 설정값이라는 점을 설명해야 합니다."를 본문 사례에서 어느 대목으로 확인할 수 있는가?
...
## `random_state`는 성능 손잡이가 아니라 재현성 손잡이다
