...
이 책의 현재 흐름에서는 머신러닝 실습의 비교 구조를 우선하기 때문에, 여기서는 `적합도와 복잡도를 함께 보려는 생각`이 왜 나왔는지를 잡아 둡니다.
...
## 모델 선택 이후의 도구 지도: 확인할 판단 기준

이 사례 절은 다음 질문으로 중심축을 확인한다.

- 오픈체크리스트의 중심축 문장인 "고급 모델 선택, 튜닝 자동화, 실험 추적을 큰 그림에서 읽는 법을 보충해야 합니다."를 본문 사례에서 어느 대목으로 확인할 수 있는가?
