...
P4-2.1 looked at [supervised learning](/AiBook/en/reference/concept-glossary-alpha/s/#supervised-learning), which learns from data with [labels](/AiBook/en/reference/concept-glossary-alpha/l/#label), and P4-2.2 looked at [unsupervised learning](/AiBook/en/reference/concept-glossary-alpha/u/#unsupervised-learning), which finds data structure without labels. This time we look at [reinforcement learning](/AiBook/en/reference/concept-glossary-alpha/r/#reinforcement-learning), where a model takes an [action](/AiBook/en/reference/concept-glossary-alpha/a/#action), receives a [reward](/AiBook/en/reference/concept-glossary-alpha/r/#reward) from the result, and adjusts the next way of acting.
...
In supervised learning, there could already be labels such as `from this position, right is the correct move`. In reinforcement learning, a reinforcement learning agent usually tries actions first and then adjusts the next way of acting using the rewards that come back.
...
The policy does not have to be a good rule from the beginning. In reinforcement learning, the reinforcement learning agent improves the policy by trying different actions. The policy can be a hand-written rule, or it can be a function adjusted during learning.
...
- Richard S. Sutton and Andrew G. Barto, `Reinforcement Learning: An Introduction`, 2nd ed., MIT Press, 2018, accessed 2026-07-26. [https://mitpress.mit.edu/9780262039246/reinforcement-learning/](https://mitpress.mit.edu/9780262039246/reinforcement-learning/){: target="_blank" rel="noopener noreferrer" }
- Olivier Buffet, Olivier Pietquin, Paul Weng, `Reinforcement Learning`, arXiv, 2020, accessed 2026-07-26. [https://arxiv.org/abs/2005.14419](https://arxiv.org/abs/2005.14419){: target="_blank" rel="noopener noreferrer" }
