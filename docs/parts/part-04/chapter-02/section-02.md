...
이 절은 먼저 `라벨 없는 데이터에서 구조를 읽는 비지도학습이 어떤 문제를 다루는가`를 닫습니다. k-means와 DBSCAN은 P4-17 클러스터링에서, PCA와 t-SNE는 P4-18 차원 축소에서 이어집니다.
...
- 오픈체크리스트의 중심축 문장인 "비지도학습이 정답 없이 구조 후보를 읽는 일이라는 점을 분명히 해야 합니다."를 본문 사례에서 어느 대목으로 확인할 수 있는가?
