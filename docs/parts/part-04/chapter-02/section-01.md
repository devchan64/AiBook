...
- [학습(training)](../../../reference/concept-glossary-parts/05-mieum.md#model-training), [평가(evaluation)](../../../reference/concept-glossary-parts/13-pieup.md#evaluation-design), [예측(prediction)](../../../reference/concept-glossary-parts/08-ieung.md#prediction)은 어떻게 이어지는가?
...
- 오픈체크리스트의 중심축 문장인 "지도학습이 라벨과 목표값을 가진 문제 구조라는 점을 닫아야 합니다."를 본문 사례에서 어느 대목으로 확인할 수 있는가?
