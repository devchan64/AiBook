...
这一节不会长篇重复降维的基本定义。`把很多特征重新表达成更少的轴`这一核心直觉，会通过 P4-18.1 重新连回来；这里则集中处理：这种图会带来哪些[信息损失(information loss)](/AiBook/zh/reference/concept-glossary-pinyin/i/#information-loss)，以及哪些解释风险。
