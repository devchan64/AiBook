...
이때 OOB를 점수 하나로만 두지 말고, 어떤 비교 기준과 어떤 남는 사례를 함께 적을지 바로 정리해 두는 편이 안전합니다. 같은 OOB나 test 점수처럼 보여도 반복해서 남는 오류 유형이 다를 수 있으므로, 점수 패턴과 사례 패턴을 함께 읽는 편이 맞습니다.
...
이 절에서는 여기서 한 번 더 멈춰, `지금 당장 무엇을 바꿀 것인가`와 `아직 나중으로 미룰 판단은 무엇인가`를 같이 구분해 두는 편이 안전합니다.
