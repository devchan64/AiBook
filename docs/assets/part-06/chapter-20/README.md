...
- P6-20 encoder and understanding-task language pairs:
  - `p6-c20-s01-encoder-representation-flow-en.mmd` / `p6-c20-s01-encoder-representation-flow-ko.mmd` / `p6-c20-s01-encoder-representation-flow-zh.mmd`
  - `p6-c20-s02-understanding-output-flow-en.mmd` / `p6-c20-s02-understanding-output-flow-ko.mmd` / `p6-c20-s02-understanding-output-flow-zh.mmd`
