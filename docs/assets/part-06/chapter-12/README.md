# Part 6 Chapter 12 Mermaid Assets
...
- Current language pairs:
  - `p6-c12-s01-diagram-01-en.mmd` / `p6-c12-s01-diagram-01-ko.mmd`
  - `p6-c12-s01-diagram-02-en.mmd` / `p6-c12-s01-diagram-02-ko.mmd`
  - `p6-c12-s02-diagram-01-en.mmd` / `p6-c12-s02-diagram-01-ko.mmd`
  - `p6-c12-s02-diagram-02-en.mmd` / `p6-c12-s02-diagram-02-ko.mmd`
