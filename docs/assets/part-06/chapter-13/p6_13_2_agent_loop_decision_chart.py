...
LANG_TEXT = {
    "ko": {
        ...
        "ylabel": "해당 목표 수",
        "labels": ["계속 진행", "종료", "사람 검토"],
    },
    "en": {
        "font_candidates": ["DejaVu Sans", "Arial Unicode MS"],
        "outfile": "agent-loop-decision-split-en.png",
        "ylabel": "matching goals",
        "labels": ["continue", "stop", "human review"],
    },
}
...
def save_chart(text: dict[str, str]) -> None:
    ...
    for bar in bars:
        ...
        ratio = value / SUMMARY["scenario_count"]
        ax.annotate(
            f"{value:g}\n({ratio:.0%})",
    ...
    ax.set_ylim(0, SUMMARY["scenario_count"] * 1.25)
