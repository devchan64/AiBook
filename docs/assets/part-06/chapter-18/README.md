...
- P6-18 request flow language pairs:
  ...
  - `p6_18_2_policy_documents.csv` stores the P6-19.2 policy document inputs used by the manuscript example and chart.
  - `p6_18_2_policy_questions.csv` stores the P6-19.2 request inputs used by the manuscript example and chart.
  - `p6_18_2_generate_run_records.py` generates P6-19.2 request run records from the CSV inputs.
  - `p6_18_2_policy_documents_en.csv`, `p6_18_2_policy_questions_en.csv`, and `p6_18_2_generate_run_records_en.py` are English companion assets for the P6-19.2 translated manuscript.
  - `p6_18_2_policy_documents_zh.csv`, `p6_18_2_policy_questions_zh.csv`, and `p6_18_2_generate_run_records_zh.py` are Chinese companion assets for the P6-19.2 translated manuscript.
