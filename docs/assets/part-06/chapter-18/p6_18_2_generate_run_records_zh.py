...
DOCUMENTS_CSV = OUT_DIR / "p6_18_2_policy_documents_zh.csv"
QUESTIONS_CSV = OUT_DIR / "p6_18_2_policy_questions_zh.csv"
...
def draft_answer(question, retrieved):
    ...
    if len(positive_docs) == 1:
        summary_line = (
            "Draft judgment: 只找到一份依据文档，因此应再次检查例外条款和最新通知。"
        )
    else:
        summary_line = (
