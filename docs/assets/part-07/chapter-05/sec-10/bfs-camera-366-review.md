...
- **의상 디자인:** 009·011·019·022·026·028·029에서 칼라 또는 목선 변화가 눈에 띈다. 색을 유지한 것과 디자인을 보존한 것은 구분한다.
...
- **P712-CAM-019·022:** 목선이 더 깊은 V 형태로 바뀐다.
...
| P712-CAM-022 · woman / level / -45° | ![P712-CAM-022 입력](../sec-12/codex-camera-inputs-v1/woman-level-minus-45-512.png) | ![P712-CAM-022 적용](codex-camera-lora-366-v1/woman-level-minus-45-lora.png) | 손 흔들기·열린 웃음 유지. 둥근 주름 목선이 V 형태로 바뀜. 얼굴 변환과 별개로 의상 보존 보완 대상. |
