...
OUTPUT_DIR = Path("/tmp/p7-5-2-flux2-rear-view-matched-reference")
CASES = [
    ("front_reference", ROOT / "docs/assets/part-07/chapter-05/p7-5-2-mira-single-reference-01.png"),
    ("rear_reference", ROOT / "docs/assets/part-07/chapter-05/p7-5-2-mira-single-reference-12-rear-three-quarter.png"),
]
PROMPT = (
