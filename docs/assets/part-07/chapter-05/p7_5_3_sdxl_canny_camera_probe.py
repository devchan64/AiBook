...
def main() -> int:
    ...
    reference = Image.open(args.reference_dir / "p7-5-1-mira-single-reference-01.png").convert("RGB")
    ...
    output_path = args.output / "p7-5-3-sdxl-canny-camera-on-off.png"
    ...
    (args.output / "p7-5-3-sdxl-canny-camera-on-off.json").write_text(json.dumps(record, ensure_ascii=False, indent=2) + "\n")
    print(output_path)
    return 0
