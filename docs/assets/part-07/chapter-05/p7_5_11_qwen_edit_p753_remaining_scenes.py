...
SUBJECT = ROOT / "docs/assets/part-07/chapter-05/sec-03/p7-5-3-face-front-reference.png"
...
OUTFIT = ROOT / "docs/assets/part-07/chapter-05/sec-03/p7-5-3-fullbody-front-refined-reference.png"
STORYBOARD = {
    scene: {
        "storyboard-depth": ROOT / f"docs/assets/part-07/chapter-05/sec-03/p7-5-3-scene-{scene}-approved-storyboard-depth.png",
        "storyboard-rgb": ROOT / f"docs/assets/part-07/chapter-05/sec-03/p7-5-3-scene-{scene}-approved-storyboard-rgb.png",
    }
    for scene in ("a", "b", "c")
}
IDENTITY_CONTRACT = ROOT / "docs/assets/part-07/chapter-05/sec-02/p7-5-2-mira-identity-contract.json"
