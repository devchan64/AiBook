...
DEFAULT_IMAGE = ASSETS / "section-05/p7-5-5-qwen-2511-pose-identity-official-camera-scene-a-tryon-camera-replace-v1-size-1280x1280-seed-62294-steps-20.png"
...
def main() -> None:
    ...
    stem = f"p7-5-5-qwen-2509-relight-scene-{args.scene}-{args.run_label}-size-{args.size}x{args.size}-seed-{args.seed}-steps-{args.steps}"
