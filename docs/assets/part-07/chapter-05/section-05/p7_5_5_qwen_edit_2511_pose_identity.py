...
SHADOW_POSES = {
    "a": ASSETS / "section-05/p7-5-5-qwen-2511-cutout-shadow-scene-a-eye-level-v2-size-1280x1280-seed-62294-steps-10.png",
    "b": ASSETS / "section-05/p7-5-5-qwen-2511-cutout-shadow-scene-b-v1-size-1280x1280-seed-62294-steps-10.png",
    "c": ASSETS / "section-05/p7-5-5-qwen-2511-cutout-shadow-scene-c-no-closeup-v1-size-1280x1280-seed-62294-steps-10.png",
}
...
def main() -> None:
    ...
    for scene in dict.fromkeys(args.scenes):
        ...
        stem = f"p7-5-5-qwen-2511-pose-identity-official-camera-scene-{scene}-{args.run_label}-size-{args.size}x{args.size}-seed-{args.seed}-steps-{args.steps}"
        plans.append({
            "scene": scene,
            "pose": pose,
