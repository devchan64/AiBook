...
SOURCES = {
    scene: [
        ASSETS / f'section-05/p7-5-5-qwen-2511-studio-delight-background-{scene}-v1-size-1280x1280-seed-62294-steps-10.png',
        ASSETS / f'section-05/p7-5-5-qwen-2511-studio-delight-reviewed-{scene}-mira-v1-size-1280x1280-seed-62294-steps-10.png',
    ] for scene in ('a', 'b', 'c')
}
SOURCES['c'].append(ASSETS / 'section-05/p7-5-5-qwen-2511-studio-delight-reviewed-c-supporting-v1-size-1280x1280-seed-62294-steps-10.png')
