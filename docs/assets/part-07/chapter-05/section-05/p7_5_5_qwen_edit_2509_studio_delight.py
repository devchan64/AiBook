...
DEFAULT_IMAGE = ASSETS / "section-05/p7-5-5-qwen-2511-camera-a-background-camera-a-v1-size-1280x1280-seed-62294-steps-10.png"
ASSET_PRESETS: dict[str, Path | None] = {
    "mira-a-extras-v5": ASSETS / "section-05/p7-5-5-character-cutout-scene-a-mira-extras-v5-v1.png",
    "mira-b-extras-v8": ASSETS / "section-05/p7-5-5-character-cutout-scene-b-mira-extras-v8-v1.png",
    "mira-c-extras-v7": ASSETS / "section-05/p7-5-5-character-cutout-scene-c-mira-extras-v7-v1.png",
    "supporting-c-extras-v7": ASSETS / "section-05/p7-5-5-character-cutout-scene-c-supporting-extras-v7-v4.png",
    "character-a": ASSETS / "section-05/p7-5-5-qwen-2511-pose-identity-official-camera-scene-a-shadow-stage2-outfit-v1-size-1280x1280-seed-62294-steps-30.png",
    "character-b": ASSETS / "section-05/p7-5-5-qwen-2511-pose-identity-official-camera-scene-b-shadow-stage2-outfit-v1-size-1280x1280-seed-62294-steps-30.png",
    "character-c": ASSETS / "section-05/p7-5-5-qwen-2511-pose-identity-official-camera-scene-c-shadow-stage2-outfit-no-closeup-v2-size-1280x1280-seed-62294-steps-30.png",
    "background-a": ASSETS / "section-05/p7-5-5-qwen-2511-camera-a-background-camera-a-v1-size-1280x1280-seed-62294-steps-10.png",
    "background-b": ASSETS / "section-05/p7-5-5-qwen-2511-camera-b-background-camera-b-v1-size-1280x1280-seed-62294-steps-10.png",
    "background-c": ASSETS / "section-05/p7-5-5-qwen-2511-camera-c-background-camera-c-v1-size-1280x1280-seed-62294-steps-10.png",
}
...
def main() -> None:
    ...
    stem = f"p7-5-5-qwen-2509-studio-delight-{run_label}-size-{args.size}x{args.size}-seed-{args.seed}-steps-{args.steps}"
