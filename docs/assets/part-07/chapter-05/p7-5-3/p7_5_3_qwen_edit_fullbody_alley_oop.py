...
OUTFIT_REFERENCE = ASSETS / (
    'p7-5-3/p7-5-3-qwen-edit-prompt-style-outfit_stage3_jacket_face-three-stage-v1-seed-62294-steps-10.png'
)
...
def main() -> None:
    ...
    output = ASSETS / "p7-5-3" / f"{stem}.png"
    result_record = ASSETS / "p7-5-3" / f"{stem}-result.json"
