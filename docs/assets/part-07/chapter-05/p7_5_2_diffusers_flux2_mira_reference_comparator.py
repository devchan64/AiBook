...
OUTPUT_DIR = Path(os.environ.get("OUTPUT_DIR", "/tmp/p7-5-2-flux2-mira-reference-comparator"))
WIDTH = int(os.environ.get("WIDTH", "512"))
HEIGHT = int(os.environ.get("HEIGHT", "768"))
MIRA_REFERENCE = ROOT / "docs/assets/part-07/chapter-05/p7-5-2-mira-single-reference-01.png"
MALE_REFERENCE = ROOT / "docs/assets/part-07/chapter-05/p7-5-2-comparator-male-webtoon-no-bag.png"
WATERCOLOR_REFERENCE = ROOT / "docs/assets/part-07/chapter-05/p7-5-2-comparator-woman-watercolor-no-bag.png"
