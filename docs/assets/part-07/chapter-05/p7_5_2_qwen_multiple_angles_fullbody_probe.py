#!/usr/bin/env python3
"""Test full-body yaw views from the P7-5.2 stage-3 headless outfit reference.
...
DEFAULT_REFERENCE = ASSETS / "p7-5-2-qwen-edit-prompt-style-outfit_stage3_headless-relaxed-arms-v1-seed-62294-steps-20.png"
...
def main() -> None:
    ...
    parser.add_argument("--run-label", default="stage3-headless-multiple-angles-v1")
    ...
    for index, target in enumerate(args.targets, start=1):
        ...
        record = {
            ...
            "input_roles": ["stage_3_headless_front_outfit"],
