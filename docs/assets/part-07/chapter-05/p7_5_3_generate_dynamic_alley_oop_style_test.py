...
IMAGE_SIZE = (768, 1152)
REFERENCE_INPUTS = (
    ("face_identity", ROOT / "p7-5-3-face-front-reference.png"),
    ("fullbody_front", ROOT / "p7-5-3-fullbody-front-reference.png"),
    ("fullbody_front_quarter", ROOT / "p7-5-3-fullbody-front-quarter-reference.png"),
    ("fullbody_profile", ROOT / "p7-5-3-fullbody-profile-reference.png"),
    ("fullbody_rear", ROOT / "p7-5-3-fullbody-rear-reference.png"),
)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-prefix",
        default="p7-5-3-dynamic-basketball-jump",
