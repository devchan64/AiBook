#!/usr/bin/env python3
"""Generate a single dynamic alley-oop full-body reference for P7-5.2."""
...
def main() -> None:
    ...
    stem = f"p7-5-2-qwen-edit-fullbody-alley-oop-{args.run_label}-seed-{args.seed}-steps-{args.steps}"
    ...
    result_record.write_text(
        json.dumps(
            {
                "status": "generated",
                "experiment_id": "p7-5-2-qwen-edit-fullbody-alley-oop",
                "model": MODEL_ID,
