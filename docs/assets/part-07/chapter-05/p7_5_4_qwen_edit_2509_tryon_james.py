...
DEFAULT_PERSON = ASSETS / "p7-5-4-qwen-2511-pose-identity-official-camera-scene-b-shadow-side-profile-v2-size-1280x1280-seed-62294-steps-20.png"
...
def main() -> None:
    ...
    stem = f"p7-5-4-qwen-2509-tryon-james-{args.run_label}-size-{args.size}x{args.size}-seed-{args.seed}-steps-{args.steps}"
