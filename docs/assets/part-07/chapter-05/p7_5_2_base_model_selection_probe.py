...
def main() -> int:
    ...
    sheet_path = args.output / "p7-5-2-base-model-selection-contact-sheet.png"
    ...
    (args.output / "p7-5-2-base-model-selection-report.json").write_text(json.dumps(report, ensure_ascii=False, indent=2) + "\n")
    print(sheet_path)
    return 0
