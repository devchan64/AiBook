...
- Visual reference: the project-generated `p7-5-1-mira-reference-sheet-draft-01.png`; it was used only to request its clean line-art properties.
- Output: `p7-5-1-clean-line-art-style-sheet-01.png` through `-05.png`, each a 2x2 sheet of generic adult people and environments.
...
- Output: `p7-5-1-clean-line-art-style-pack-02-sheet-01.png` through `-04.png`, 16 generic full-body figures.
...
- Output: `p7-5-1-mira-clean-line-scene-pack-01-sheet-01.png`.
