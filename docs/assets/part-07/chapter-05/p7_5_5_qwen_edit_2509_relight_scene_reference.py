...
from p7_5_5_qwen_edit_2511_pose_identity import (
    ASSETS, CACHE_DIR, runtime_record, sha256, square_canvas,
)
...
SOURCES = {
    scene: [ASSETS / f'p7-5-5-qwen-2511-delight-composite-scene-{scene}-v1-size-1280x1280-seed-62294-steps-10.png']
    for scene in ('a', 'b', 'c')
}
PROMPT_BASIS = {
