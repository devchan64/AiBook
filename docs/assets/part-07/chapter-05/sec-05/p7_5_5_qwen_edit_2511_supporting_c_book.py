#!/usr/bin/env python3
"""Restore an open book to the Scene C supporting character identity result.

Picture 1 is the supporting character identity image. This second pass uses a single image,
...
SOURCE = ASSETS / 'sec-05/p7-5-5-qwen-2511-cutout-identity-c-supporting-audit-20260909-v1-size-1280x1280-seed-62294-steps-30.png'
PROMPT = 'Add an open book held in both hands over the lap of the man in Picture 1.'
...
def main() -> None:
    ...
    parser.add_argument('--output-dir', type=Path, default=ASSETS / "sec-05")
    ...
    stem = (f'p7-5-5-qwen-2511-identity-c-supporting-stage2-{args.run_label}'
    ...
    plans = [dict(scene='c', inputs=[
        dict(role='Picture 1: Scene C supporting character identity',
