...
STYLE = ROOT / "docs/assets/part-07/chapter-05/p7-5-2-local-style-pack-v1-station-master.png"
CHARACTER = ROOT / "docs/assets/part-07/chapter-05/p7-5-2-local-style-conditioned-character-pack-v1-master.png"
OUTPUT_DIR = Path("/tmp/p7-5-2-style-character-cutscene-ablation")
PROMPT = (
