...
def main() -> int:
    ...
    sheet_path = args.output / "p7-5-2-sdxl-lora-canny-on-off.png"
    ...
    (args.output / "p7-5-2-sdxl-lora-canny-on-off.json").write_text(json.dumps(record, ensure_ascii=False, indent=2) + "\n")
    print(sheet_path)
    return 0
