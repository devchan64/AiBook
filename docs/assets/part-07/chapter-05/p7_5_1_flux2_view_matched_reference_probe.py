...
OUTPUT_DIR = Path("/tmp/p7-5-1-flux2-view-matched-reference")
CASES = [
    ("front_reference", ROOT / "docs/assets/part-07/chapter-05/p7-5-1-mira-single-reference-01.png"),
    ("side_reference", ROOT / "docs/assets/part-07/chapter-05/p7-5-1-mira-single-reference-14-side-walk-pause.png"),
]
PROMPT = (
