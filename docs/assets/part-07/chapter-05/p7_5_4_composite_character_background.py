...
DEFAULT_CHARACTER = ASSETS / "p7-5-4-qwen-2509-pose-transfer-plus90-replace-v2-seed-62294-steps-10.png"
DEFAULT_MASK = ASSETS / "p7-5-4-sam2-person-mask-pose-transfer-plus90-replace-v2.png"
DEFAULT_BACKGROUND = ASSETS / "p7-5-4-lama-background-scene-a-v3.png"
