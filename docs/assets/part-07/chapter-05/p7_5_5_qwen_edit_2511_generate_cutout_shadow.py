...
CUTOUTS = {
    ...
    "c": ASSETS / "p7-5-5-character-pose-cutout-white-official-camera-scene-c-no-closeup-v9-size-1280x1280.png",
}
PERSON_MASKS = {
    "a": ASSETS / "p7-5-3-sam2-person-mask-official-camera-scene-a-v6.png",
    "b": ASSETS / "p7-5-5-sam2-person-mask-official-camera-scene-b-v7.png",
    "c": ASSETS / "p7-5-5-sam2-person-mask-official-camera-scene-c-no-closeup-v9.png",
}
...
def main() -> None:
    ...
    stem = f"p7-5-5-qwen-2511-cutout-shadow-scene-{args.scene}-{args.run_label}-size-{args.size}x{args.size}-seed-{args.seed}-steps-{args.steps}"
