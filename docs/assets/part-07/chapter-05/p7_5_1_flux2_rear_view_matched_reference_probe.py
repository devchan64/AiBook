"""Compare front and rear-matched references for one FLUX.2 Klein rear whole-shot cut."""
...
OUTPUT_DIR = Path("/tmp/p7-5-1-flux2-rear-view-matched-reference")
CASES = [
    ("front_reference", ROOT / "docs/assets/part-07/chapter-05/p7-5-1-mira-single-reference-01.png"),
    ("rear_reference", ROOT / "docs/assets/part-07/chapter-05/p7-5-1-mira-single-reference-12-rear-three-quarter.png"),
]
PROMPT = (
    "Create one polished full-body Korean webtoon panel of the exact same young woman in the reference image. "
    "Show a rear three-quarter view as she walks away through a quiet cinema lobby and looks back over her right shoulder. "
    "Keep her teal bob haircut and silver hair clip, white cropped utility jacket, charcoal shirt, teal wide-leg trousers, "
    "white sneakers, and exactly one navy horizontal flap shoulder bag at her right hip with one diagonal strap across her back. "
    ...
    try:
        ...
        for case_id, reference in CASES:
            ...
            image = pipe(
                ...
                guidance_scale=1.0,
                generator=torch.Generator(device="cpu").manual_seed(320302),
            ...
            json.dumps(
                {
                    ...
                    "purpose": "single variable comparison: front versus rear-matched reference on one rear three-quarter whole-shot contract",
                    "prompt": PROMPT,
                    "size": [512, 768],
                    "steps": 4,
                    "guidance_scale": 1.0,
