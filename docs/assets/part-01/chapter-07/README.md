...
- Current language sets:
  ...
  - `search-space-growth-en.png` / `search-space-growth-ko.png` / `search-space-growth-zh.png`
  - `p1_7_3_threshold_action_regions.py`
  - `threshold-action-regions-en.png` / `threshold-action-regions-ko.png` / `threshold-action-regions-zh.png`
