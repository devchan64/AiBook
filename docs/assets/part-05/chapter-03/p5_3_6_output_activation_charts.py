...
LANG_TEXT = {
    ...
    "zh": {
        ...
        "regression_out": "output-activation-regression-distance-zh.svg",
        "binary_out": "output-activation-binary-threshold-zh.svg",
        "multiclass_out": "output-activation-multiclass-gap-zh.svg",
        "regression_xlabel": "能耗（kWh）",
        "regression_actual": "实际值 12.4",
        "regression_predicted": "预测值 12.7",
        "regression_error": "误差 0.3 kWh",
        "regression_band": "允许误差范围",
        "regression_title": "回归输出应按与正确答案的距离来读",
        "regression_desc": "通过标出实际能耗 12.4kWh 与预测值 12.7kWh 之间的距离，说明回归输出应被读成连续数值误差，而不是概率。",
        "binary_xlabel": "sigmoid 输出分数",
        "binary_y": "警报",
        "binary_low": "仅记录",
        "binary_mid": "现场确认",
        "binary_high": "自动停机",
        "binary_threshold_mid": "0.60",
        "binary_threshold_high": "0.90",
        "binary_title": "二元分类输出应按阈值区间来读",
        "binary_desc": "展示 sigmoid 输出 0.30、0.65、0.91 分别落入仅记录、现场确认、自动停机区间的图表。",
        "multiclass_ylabel": "softmax 输出",
        "multiclass_classes": ["正常", "划痕", "污染"],
        "multiclass_gap": "第一名差距 0.04",
        "multiclass_title": "多分类输出应按候选分数差距来读",
        "multiclass_desc": "比较 正常 0.38、划痕 0.34、污染 0.28 的 softmax 柱状图，说明第一名与第二名差距很小时可能需要复核。",
    },
}
