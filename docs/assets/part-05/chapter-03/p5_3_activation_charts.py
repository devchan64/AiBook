...
LANG_TEXT = {
    ...
    "zh": {
        ...
        "xlabel": "线性分数 z",
        "ylabel": "激活输出 a",
        "sigmoid_out": "sigmoid-curve-zh.svg",
        "tanh_out": "tanh-curve-zh.svg",
        "relu_out": "relu-curve-zh.svg",
        "nonlinear_out": "nonlinear-activation-example-zh.svg",
        "case_before_after_out": "activation-case-before-after-zh.svg",
        "experiment_shift_out": "activation-experiment-shift-zh.svg",
        "sigmoid_title": "sigmoid 激活函数曲线",
        "sigmoid_desc": "展示 sigmoid 曲线在大负数时接近 0、在 z 等于 0 时为 0.5、在大正数时接近 1 的坐标图。",
        "tanh_title": "tanh 激活函数曲线",
        "tanh_desc": "展示 tanh 曲线在大负数时接近 -1、在 z 等于 0 时为 0、在大正数时接近 1 的坐标图。",
        "relu_title": "ReLU 激活函数曲线",
        "relu_desc": "展示 ReLU 曲线在负数区间保持 0、在 z 大于等于 0 时线性增长的坐标图。",
        "nonlinear_title": "非线性激活变换的教学示例",
        "nonlinear_desc": "比较直接线性通过与按不同输入区间改变反应的非线性激活示例的坐标图。",
        "case_before_after_title": "激活前后运行信号比较",
        "case_before_after_desc": "比较四种运行状态中激活前线性分数 z 与激活后数值 a 如何变化的坐标图。",
        "experiment_shift_title": "输入调整引起的激活前后变化",
        "experiment_shift_desc": "比较偏置、失败权重、恢复延迟分数变化如何改变激活后数值 a 的坐标图。",
        "linear_pass": "线性通过 a = z",
        "nonlinear_pass": "非线性变换 a = f(z)",
        "negative_band": "负数区间会被削弱",
        "middle_band": "中间区间较直接地传递",
        "high_band": "较大正数会再次被压缩",
        "z_label": "激活前 z",
        "a_label": "激活后 a",
        "before_label": "调整前 a",
        "after_label": "调整后 a",
        "threshold_label": "阈值 0",
        "case_labels": ["短暂警报", "恢复占优", "边界信号", "强警告"],
        "experiment_labels": ["降低偏置", "提高失败权重", "降低恢复延迟"],
    },
}
