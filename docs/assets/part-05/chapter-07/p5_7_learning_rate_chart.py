...
LANG_TEXT = {
    ...
    "zh": {
        ...
        "outfile": "learning-rate-step-size-zh.svg",
        "title": "学习率与损失曲线上的步幅",
        "desc": "这张坐标图展示：即使梯度方向相同，学习率太小时移动会很慢，比较合适时会靠近低损失区域，太大时则会越过目标并让损失重新变大。",
        "xlabel": "参数",
        "ylabel": "损失",
        "origin": "当前位置",
        "small": "太小",
        ...
        "valley": "低损失附近",
        "lr_labels": ["lr=0.01", "lr=0.1", "lr=0.5"],
        "weight_ylabel": "更新后的风险权重",
        "score_ylabel": "更新后的阻断分数",
        "loss_ylabel": "更新后的损失",
        "lr_xlabel": "学习率",
        "target_label": "目标",
        "step_labels": ["第 1 步", "第 2 步", "第 3 步"],
        "gradient_title": "输入 gradient 流",
        "gradient_ylabel": "gradient_risk_weight",
        "delta_title": "转换后的逐步移动量",
        "delta_ylabel": "delta",
        "weight_title": "输出 risk_weight 的移动路径",
        "weight_ylabel_trace": "risk_weight",
        "step_xlabel": "训练 step",
        "direct_label": "直接 update",
        "adam_label": "Adam-like",
        "before_after_stage_labels": ["更新前", "更新后"],
        "before_after_weight_title": "update 应用前后的风险权重",
        "before_after_weight_ylabel": "risk_weight",
        "before_after_score_title": "update 应用前后的阻断分数",
        "before_after_score_ylabel": "predicted_block_score",
        "before_after_loss_title": "update 应用前后的损失",
        "before_after_loss_ylabel": "loss",
        "state_chart_title_left": "当前 gradient 相同",
        "state_chart_title_right": "因为 state 不同而得到不同 update",
        "state_same_gradient_label": "当前 gradient",
        "state_update_label": "得到的 update",
        "state_case_large": "已经积累了较大历史",
        "state_case_quiet": "一直较安静的坐标",
        "clip_title": "clipping 压住 spike 的场景",
        "clip_raw_label": "没有 clipping",
        "clip_clipped_label": "应用 clipping",
        "clip_ylabel": "update 大小",
        "claim_curve_title": "观察到的 loss 曲线不等于收敛保证",
        "claim_curve_ylabel": "training loss",
        "claim_curve_fast": "观察 A：快速下降",
        "claim_curve_slow": "观察 B：较慢下降",
        "claim_curve_osc": "观察 C：振荡",
    },
}
