...
LANG_TEXT = {
    ...
    "zh": {
        ...
        "loss_shapes_out": "loss-shapes-zh.svg",
        "squared_loss_out": "squared-error-loss-zh.svg",
        "cross_entropy_loss_out": "cross-entropy-loss-zh.svg",
        "problem_axes_out": "problem-loss-axes-zh.svg",
        "regression_axis_out": "regression-loss-axis-zh.svg",
        "classification_axis_out": "classification-loss-axis-zh.svg",
        "generation_axis_out": "generation-loss-axis-zh.svg",
        "batch_priority_out": "loss-example-batch-priority-zh.svg",
        "regression_experiment_out": "loss-example-regression-experiment-zh.svg",
        "classification_experiment_out": "loss-example-classification-experiment-zh.svg",
        "generation_experiment_out": "loss-example-generation-experiment-zh.svg",
        "loss_shapes_title": "平方误差与交叉熵损失形状",
        "loss_shapes_desc": "并列展示回归中预测离目标越远损失越大，以及分类中给正确类别的概率越低损失越大的坐标图。",
        "squared_loss_title": "平方误差损失形状",
        "squared_loss_desc": "展示预测离目标值越远时平方误差损失会更陡地增大的坐标图。",
        "cross_entropy_loss_title": "交叉熵损失形状",
        "cross_entropy_loss_desc": "展示给正确类别的概率越低时交叉熵损失会迅速增大的坐标图。",
        "problem_axes_title": "按问题类型阅读损失的坐标轴",
        "problem_axes_desc": "比较回归、分类、生成分别在与目标值的距离、正确类别概率、各位置正确 token 概率这三种不同坐标轴上阅读损失的坐标图。",
        "regression_axis_title": "回归损失阅读轴",
        "regression_axis_desc": "展示回归问题中的损失主要围绕与目标值的距离来阅读的坐标图。",
        "classification_axis_title": "分类损失阅读轴",
        "classification_axis_desc": "展示分类问题中的损失主要围绕给正确类别的概率来阅读的坐标图。",
        "generation_axis_title": "生成损失阅读轴",
        "generation_axis_desc": "展示生成问题中的损失会按位置累积正确 token 概率来阅读的柱状图。",
        "batch_priority_title": "按批次修正候选比较平均损失与最坏情况",
        "batch_priority_desc": "比较当前状态、修正 restart_delay_batch、修正 night_shift_batch 时平均损失和最大样本损失如何变化的柱状图。",
        "regression_experiment_title": "回归预测修正前后的损失",
        "regression_experiment_desc": "展示把能耗预测移近目标值时回归损失如何下降的柱状图。",
        "classification_experiment_title": "分类正确类别概率修正前后的损失",
        "classification_experiment_desc": "展示提高正确类别概率时分类损失如何下降的柱状图。",
        "generation_experiment_title": "生成正确 token 概率修正前后的损失",
        "generation_experiment_desc": "展示提高正确 token 概率时生成损失如何下降的柱状图。",
        "regression_panel": "回归：平方误差",
        "classification_panel": "分类：交叉熵直觉",
        "loss_ylabel": "损失",
        "regression_xlabel": "离目标值的距离",
        "classification_xlabel": "分给正确类别的概率",
        "small_error": "小误差",
        "large_error": "大误差",
        "low_true_prob": "正确类别概率低",
        "high_true_prob": "正确类别概率高",
        "problem_panels": [
            ("回归", "离目标值的距离"),
            ("分类", "正确类别概率"),
            ("生成", "各位置正确 token 概率"),
        ...
        "token_labels": ["t1", "t2", "t3", "t4"],
        "scenario_labels": ["当前", "修正\nrestart", "修正\nnight"],
        "current_fix_labels": ["当前", "修正后"],
        "mean_loss_label": "平均损失",
        "worst_loss_label": "最坏损失",
        "regression_loss_label": "回归损失",
        "classification_loss_label": "分类损失",
        "generation_loss_label": "生成损失",
    },
    "en": {
