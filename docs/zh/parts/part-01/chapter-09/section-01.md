...
当你把深度学习的转折点只说成“性能提高了”，却漏掉了表征学习的意义时，就应该先回到这一节。

- 当需要对比“人手工设计特征”和“模型连同表征一起学习”的两种方式时
- 当需要用直觉层面说明 CNN 为什么在图像里重要时
- 当需要把 AlexNet 安全地放在“扩散的转折点”，而不是“绝对最初起点”时

这时先分开看三个问题就够了：为什么这个问题很难写成固定规则，人设计了什么、模型又学到了什么，以及为什么数据、GPU 和模型结构必须一起看。这样就能在不过度夸大历史案例的前提下，更清楚地说明深度学习范式的变化。
