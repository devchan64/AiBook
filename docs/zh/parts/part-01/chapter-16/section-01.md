...
在个人学习中，AI 不是答案纸，而是帮助你组织学习结构的工具。
...
- 当 AI 被当成个人学习的答案纸，而不是结构化工具时
- 当文档化只被当成记笔记，而不是验证装置时
- 当个人直觉与经过验证的说明准备被写进同一段时

这时，先把 `问题结构化`、`文档化`、`依据审查`、`工作假设保存` 分开，会更容易重新把 AI 看成学习流程整理工具，而不是万能答案器。
