...
这一节会说明 `unsupervised learning`、`在没有标签时阅读结构`、`clustering` 和 `dimensionality reduction` 之间的大体区分。后面的章节会带着这个抓手继续判断当前语境，而 `结构探索到底是什么意思` 这个基础含义，会通过本节和 [概念词汇表](../../../reference/concept-glossary.md) 再次接回。
