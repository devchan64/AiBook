...
![从单变量微分扩展到多个方向的偏微分与梯度的流程](../../../assets/part-02/chapter-04/gradient-single-to-multiple-directions-en.svg)
...
![比较偏导数与方向导数所观察方向的图](../../../assets/part-02/chapter-04/partial-vs-directional-derivative-en.svg)
...
![显示标量场、梯度和向量场在向量分析中连接位置的图](../../../assets/part-02/chapter-04/vector-calculus-context-en.svg)
...
![在损失函数等高线上比较梯度方向与下降方向的图](../../../assets/part-02/chapter-04/gradient-direction-loss-contour-en.svg)
...
![显示梯度下降是朝更低损失方向重复小步移动的图](../../../assets/part-02/chapter-04/gradient-descent-steps-en.svg)
...
![显示梯度下降更新表示从当前值沿梯度反方向小步移动的图](../../../assets/part-02/chapter-04/gradient-descent-update-intuition-en.svg)
...
![比较前向传播计算方向与反向传播中梯度回传方向的图](../../../assets/part-02/chapter-04/backpropagation-gradient-flow-en.svg)
...
- 当高中微分记忆和 AI 学习文档之间的间隔很大，以至于梯度、梯度下降、反向传播一下子全都显得陌生时，就先想起它。
- 当你需要慢慢重新整理：偏微分、方向导数、梯度各自在看什么不同时，就先想起它。
- 当正文里的说明仍然不足以支撑一个需要更多多变量微分直觉的读者时，就先想起它。
