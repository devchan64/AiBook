...
![从总体中抽出样本并用样本形成估计值的流程](../../../assets/part-02/chapter-05/population-sample-estimate-zh.svg)
...
![把估计值与真实值之间的差读成误差的图](../../../assets/part-02/chapter-05/estimate-error-gap-zh.svg)
...
![比较抽样波动与抽样偏差的图](../../../assets/part-02/chapter-05/sampling-variation-vs-bias-zh.svg)
