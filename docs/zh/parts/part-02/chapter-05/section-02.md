...
![一起读取分布、均值和方差的图](../../../assets/part-02/chapter-05/distribution-mean-variance-summary-zh.svg)
...
![均值相同但方差不同的两组数据](../../../assets/part-02/chapter-05/same-mean-different-variance-zh.svg)
