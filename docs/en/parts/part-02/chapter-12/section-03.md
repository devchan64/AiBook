...
This Section explains the basic distinction among dataset, feature, target, validation, and data leakage. The representative explanation of `DataFrame` and table selection stays in P2-12.1, P2-12.2, and the [concept glossary](../../../reference/concept-glossary.md). Here, the focus is on how to reorganize that table into learning inputs and answers.
...
- In tabular data, what is the input `X` and what is the answer `y`?
- Why should some columns be kept and others removed?
- Why do we divide data into train, validation, and test?
- Why does a wrong preprocessing order create data leakage?
- What role does Pandas play in this preparation process?
