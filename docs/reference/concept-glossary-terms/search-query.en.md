...
- Meaning: A search query is the new input currently being compared or used to retrieve candidates. In k-NN, it is compared with stored training examples to find nearby neighbors; in search, it is the reference expression used to retrieve candidates.
