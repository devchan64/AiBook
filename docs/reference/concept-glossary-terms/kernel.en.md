...
- Meaning: A core function that takes two inputs and computes how similar or close they are in a richer representation space. In boundary-based classification, it is read as the idea of getting the comparison effect of a new feature space through calculations in the original space, without explicitly building every new feature.
...
- Related concepts: `feature space`, `distance`, `decision boundary`, `dimensionality reduction`
