...
- Why it matters: In array and nested-data preprocessing, selecting part of a structure can still share data with the original. Understanding copies prevents accidental source modification while also making memory cost visible.
