...
- Meaning: A score is a numeric value that a model assigns to a candidate output or decision target. A score can be used for comparison, ranking, or thresholding, but it does not always mean a calibrated probability.
