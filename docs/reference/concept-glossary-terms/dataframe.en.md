...
- Meaning: A DataFrame is a two-dimensional table structure with row and column labels and columns that can hold different types.
...
- Related concepts: `dataset`, `row`, `column`
