...
- **P7-4.5 Stable Diffusion과 LoRA 조합 실습**: Stable Diffusion base 모델에 LoRA adapter를 얹고, prompt와 seed를 고정한 상태에서 adapter weight 변화가 결과와 실패 기록을 어떻게 바꾸는지 비교합니다.
...
#### Chapter 6. AI 에이전트 실행과 승인 정책 `프로젝트 실습`

- **P7-6.1 계획, 도구 호출, 승인 흐름 실습**: AI 에이전트의 계획, 도구 호출 순서, 승인과 제약 지점을 실행 경로 중심으로 다룹니다.
