...
| 섹션 | 범위 | 역할 |
| --- | --- | --- |
| 1. AI의 범위와 역사 | 1-2장 | AI가 다루는 문제와 역사적 패러다임의 큰 변화를 잡습니다. |
| 2. 규칙, 모델, 학습 | 3-5장 | 명시적 규칙에서 데이터 기반 모델링으로 넘어가는 사고 방식을 정리합니다. |
| 3. 불확실성과 문제 해결 | 6-8장 | 확률, 탐색, 휴리스틱, 학습 유형을 통해 불완전한 정보에서 판단하는 방식을 봅니다. |
| 4. 딥러닝과 생성형 AI로의 전환 | 9-11장 | 딥러닝 패러다임의 확산과 LLM의 위치를 연결합니다. |
| 5. LLM 사용 경험의 핵심 요소 | 12-14장 | 프롬프트, 임베딩, 벡터 검색, 서비스 아키텍처를 하나의 사용 흐름으로 봅니다. |
| 6. 사회적 쟁점과 적용 | 15-17장 | 윤리, 저작권, 보안, 실무 사례, 미래 전망을 근거 중심으로 다룹니다. |
