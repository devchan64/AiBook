...
Part 7은 독립된 새 이론 Part가 아니라, 앞서 소개한 내용을 실습하는 공간입니다. 앞에서는 질문, 입력 단위, baseline, 비교 실험을 다루고, 중간에서는 입력 구조, 학습 곡선, 오류 사례를 해석하며, 뒤에서는 RAG, agent, 배포·운영 판단을 로그와 실패 기록으로 점검합니다.
