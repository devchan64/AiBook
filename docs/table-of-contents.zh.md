...
#### Chapter 14. AI agent `Service Structure`

- **P6-14.1 AI agent 何时成为重新选择下一步行动的目标流程**：观察把目标连接到计划、工具调用、观察与状态判断的结构。
- **P6-14.2 计划、行动、观察如何区分继续、结束与人工检查**：观察 AI agent loop 中继续探索、结束与人工检查的分支。
