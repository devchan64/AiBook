...
- 영어: 소개, 목차, Part 1 전체, Part 2~3 개요·마무리, Part 4 일부를 공개
- 중국어(간체): 소개, 목차, Part 1 전체, Part 2~3 개요·마무리, Part 4 일부를 공개

즉, 현재 시점에서 영어와 중국어(간체) 페이지는 더 이상 단순 `TBD` 상태는 아니지만, 한국어 기본 본문을 기준으로 순차 확장 중인 번역 경로로 보는 편이 정확합니다.
