...
- Transformer, LLM, 프롬프트(prompt), 임베딩(embedding), RAG(retrieval-augmented generation), AI 에이전트(AI agent)는 AI 서비스 안에서 어떻게 연결되는가?
...
- **Part 6. LLM과 생성형 AI**: 토큰, 프롬프트, 생성 설정, 임베딩, 검색, RAG, AI 에이전트, 평가를 연결합니다.
...
- 영어: 소개, 목차, Part 1부터 Part 6까지 전체의 1차 번역을 공개
- 중국어(간체): 소개, 목차, Part 1부터 Part 6까지 전체의 1차 번역을 공개
