...
- 번역 동기화 메모: 향후 다른 언어 목차에서도 Part 2 보충학습 누락 없이 같은 구조를 유지하고, Part 4 Chapter 11 보충학습도 세 갈래로 분리된 구조를 유지해야 한다.
- 번역 동기화 메모: 향후 번역본 목차에서도 Chapter 11 보충학습이 세 갈래로 분리된 구조를 유지해야 한다.
- 번역 반영 상태: 향후 반영 필요
- 관련 자산: 없음
