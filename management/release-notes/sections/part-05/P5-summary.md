...
- 번역 동기화 메모: 영어·중국어 간체 번역본의 Version, 개념사전 상대 링크, `손실 -> gradient -> 역전파/자동미분`, 6개 모듈 요약, 학습 절차 축 설명을 원문 기준 `v2026.07.16`까지 동기화했다. `v2026.07.20`은 저작권·출처 점검 항목이며 번역본 본문 Version은 `v2026.07.16`을 유지한다.
