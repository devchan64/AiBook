...
| Part 3 산출물·작업 판단 링크 | `#glossary-output-structure`, `#glossary-target`, `#glossary-column`, `#glossary-column-role-separation`, `#glossary-baseline-window`, `#model-input-window`, `#glossary-source-event`, `#glossary-delayed-label-confirmation`, `#glossary-incomplete-negative`, `#supervised-learning-label-prediction`, `#glossary-alert`, `#glossary-data-question`, `#model-input-specification`, `#glossary-feature-definition-identity`, `#glossary-comparable-reference-group`, `#glossary-reference-maintenance-strategy`, `#glossary-folding-rule`, `#glossary-skewness`, `#glossary-next-action`, `#glossary-format-consistency`, `#glossary-data-quality-check`, `#glossary-storage-structure` | `output-structure`, `target`, `data-modeling`, `baseline`, `model-input`, `source-data`, `supervised-learning-label`, `label-consistency`, `feature` 기준으로 흡수 완료 | Part 3 작업 산출물명은 새 표제로 만들지 않고 데이터 모델링의 하위 판단으로 유지 |
...
| Part 4 저빈도 모델 세부 링크 | `#center`, `#query`, `#best-split`, `#random-threshold`, `#calibration`, `#partial-dependence-plot-pdp`, `#shap`, `#mean-decrease-in-impurity-mdi`, `#high-cardinality-feature`, `#split`, `#node`, `#leaf`, `#max-depth`, `#min-samples-leaf`, `#ccp-alpha`, `#pruning`, `#exhaustive-search`, `#working-hypothesis`, `#good-enough-solution`, `#gradient-boosting`, `#solver`, `#penalty`, `#score`, `#cost`, `#histogram-binning`, `#distributed-training`, `#hessian`, `#shrinkage`, `#subsampling`, `#early-stopping`, `#metric`, `#recall`, `#policy`, `#ppo`, `#trpo`, `#a2c`, `#a3c`, `#safe-reinforcement-learning`, `#offline-reinforcement-learning`, `#domain-randomization`, `#preference-optimization`, `#exploration-cost`, `#safe-exploration`, `#likelihood-ratio-trick`, `#expected-reward`, `#log-probability`, `#q-learning`, `#sarsa`, `#state-value`, `#action-value`, `#q-value`, `#bellman-equation`, `#q-table` | `centroid`, `model-input`, `probability-calibration`, `model-score`, `recall`, `decision-tree`, `random-forest`, `hyperparameter`, `reinforcement-learning-policy`, `exploration`, `value-based-reinforcement-learning`, `policy-based-reinforcement-learning` 기준으로 흡수하거나 본문 설명으로 전환 완료 | 알고리즘·옵션명은 해당 Section 본문에서 설명하고 독립 표제 증설은 보류 |
