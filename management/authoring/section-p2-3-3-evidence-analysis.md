...
- SVG 도표는 `management/authoring/chart-guidelines.md`의 수학·개념 차트 기준에 맞춰 제목, 설명, 패널, 축, 격자, 라벨, 요약 문장을 정리했습니다.
...
- 도표 내부의 보이는 문구는 영어로 정리하고, 한국어 보조 설명은 본문 이미지 대체 텍스트와 `<desc>`에 두었습니다.
