...
이 문서는 `docs/parts/part-01/chapter-05/section-03.md`의 근거 연결과 표현 판단을 기록한 관리 메모입니다.
...
- “한국어 추론의 사전적 정의”를 외부 사전 인용 없이 단정하지 않았습니다. 본문에서는 한국어 독자가 느낄 수 있는 일반적 혼동을 설명하는 작업 기준으로 제한했습니다.
