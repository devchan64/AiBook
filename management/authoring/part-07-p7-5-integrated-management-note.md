...
- 통합 범위: `P7-5.1`~`P7-5.7`
- 대응 본문: `docs/parts/part-07/chapter-05/section-01.md`~`section-07.md`
- 통합일: 2026-08-14
...
- 얼굴 6장, 기본 전신 6장, 리파인 전신 6장은 P7-5.4 학습·증강에서 역할·조건·한계를 명시한 참고 입력이다. JSON은 상태 판정이 아니라 실행 결과와 관찰을 남긴다.
...
- 새 54장 LoRA만 적용한 뒤, 재사용 자산 `p7-5-4-openpose-fullbody-front-quarter-right-reference.png`를 직접 입력으로 넣었다. 이미지 reference·Canny·Inpaint·VTON은 모두 제외했고, Animagine XL 4.0, `960×1440`, 30 step, seed `62296`, LoRA scale `0.6`을 고정해 ControlNet scale `0.0/1.0`만 비교했다.
...
- 재현 기록: `.tmp/p7-5-4-animagine-lora54-static-openpose-quarter-right/`.
...
- 재현 기록: `.tmp/p7-5-4-animagine-lora54-declarative-openpose-reach-up/`.
...
- 재현 기록: `.tmp/p7-5-4-animagine-lora54-openpose-high-angle-ab/`.
...
- 재현 기록: `.tmp/p7-5-4-precisecam-high-angle-pitch-ab/`.
...
- 재현 기록: `.tmp/p7-5-4-precisecam-character-lora-high-angle-ab/`.
...
- 재현 기록: `.tmp/p7-5-4-precisecam-sdxl54-character-lora-high-angle-ab/`.
...
- 재현 기록: `.tmp/p7-5-4-precisecam-sdxl54-pitch-sweep/`.
...
- 재현 기록: `.tmp/p7-5-4-sdxl-control-lora-high-angle-depth/`.
...
- 재현 기록: `.tmp/p7-5-4-animagine-lora54-declarative-openpose-reach-up-lora-scale-ab/`.
...
- 재현 기록: `.tmp/p7-5-4-sdxl-mira-anonymous-high-angle-depth-role-separated/run.json`, `depth-role-separated-review-sheet.png`, `.tmp/p7-5-4-sdxl-mira-anonymous-high-angle-depth-role-separated-global-0.30-face-0.35/run.json`, `depth-role-separated-review-sheet.png`.
...
- 재현 기록: `.tmp/p7-5-4-high-angle-catvton-jacket/run-01/contact-sheet.png`.
...
- 재현 기록: `.tmp/p7-5-4-fitdit-high-angle-upperbody-tight-mask/`, `.tmp/p7-5-4-fitdit-high-angle-upperbody-complete-outfit-tight-mask/`.
...
- 재현 기록: `.tmp/p7-5-4-dreamfit-sd15-jacket-ab/`, `.tmp/p7-5-4-dreamfit-sd15-worn-reference-proxy/`, `.tmp/p7-5-4-dreamfit-sd15-high-angle-prompt/`, `.tmp/p7-5-4-dreamfit-sd15-high-angle-ab/`.
...
- 범위: 고정한 guide와 보행 pose의 두 seed만 검수한 결과다. `p7-5-4-qwen-edit-high-angle-*-reference.png`와 대응 review JSON은 P7-5.4 승인 실험 자산으로 승격했지만, 다른 guide·다른 동작·후면/가림·밀집 소품까지 일반화되었다고 보지 않는다. LoRA 학습 입력으로는 사용하지 않으며, 다음 검증은 guide 하나를 바꾸고 동일한 세 역할을 유지해 camera와 캐릭터 계약이 동시에 남는지 확인한다.
- 재현 기록: `docs/assets/part-07/chapter-05/p7-5-4-qwen-edit-high-angle-*-reference.png`, `p7-5-4-qwen-edit-high-angle-reference-review.json`, `.tmp/p7-5-4-qwen-edit-face-outfit-contract.log`, `.tmp/p7-5-4-qwen-edit-face-outfit-seed-62295.log`.
