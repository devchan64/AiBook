...
각 Part 체크포인트 노트에서는 `P6-16.1`처럼 Section ID를 기준으로 한 줄 설명을 유지한다. 이 한 줄은 해당 Section의 중심 학습 산출물로 본다.
...
```md
- `P6-16.1`: MCP를 도구와 자원을 공통 형식으로 연결하는 인터페이스 층으로 설명해야 합니다.
```

피해야 할 문장형:

```md
- `P6-16.1`: MCP 정의, 사례, 표, 참고문헌 추가 완료. 영어판 번역 필요.
```
