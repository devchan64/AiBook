...
- `management/glossary-indexes/`는 개념사전의 언어별 표제어 탐색과 용어 대응을 맡는 보조 관리 폴더이며, 최종 정의 원고는 `docs/reference/concept-glossary.md`와 `docs/reference/concept-glossary-parts/`에 둔다.
