...
- `management/glossary-indexes/`는 개념사전의 언어별 표제어 탐색과 용어 대응을 맡는 보조 관리 폴더이며, 최종 정의 원고는 `docs/reference/concept-glossary-entries/`의 단어별 canonical 파일에 둔다. 한국어 자음별 페이지, 영어 알파벳 페이지, 중국어 병음 페이지는 정의를 직접 중복하지 않고 단어별 항목 파일을 include하는 색인 원고로 관리한다.
